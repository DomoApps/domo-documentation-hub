...
2. Second step with an inline icon <i className="icon-gear" aria-hidden="true" /> from the Domo icon font. Browse available icons at [Domo Icons](https://git.empdev.domo.com/pages/Development/DomoIcons/#!/icons/domocons).
