...
Klicken Sie für den Zugriff auf das Hilfecenter einfach rechts oben auf dem Bildschirm auf das <i className="icon-question-circle" aria-hidden="true" /> -Symbol.

<Frame><img alt="new_help_center_rn.png" src="/images/kb/ka05w00000129uT-00N5w00000Ri7BU-0EM5w000005vOjM.png"/></Frame>
## Hilfe anfordern

Sie können die neuesten Versionshinweise im Hilfecenter aufrufen. Auf das Hilfecenter können Sie von Domo aus zugreifen, wenn Sie in der Navigationsleiste oben auf <i className="icon-question-circle" aria-hidden="true" /> klicken.
