...
Klicken Sie für den Zugriff auf das Hilfecenter einfach rechts oben auf dem Bildschirm auf das <i className="icon-question-circle sm" aria-hidden="true" /> -Symbol.
