...
* Damit Sie die Ressourcen, Videos, Wissensdatenbank-Artikel und Dojo-Inhalte der Domo University schneller finden können, wurde das Domo-Hilfecenter-Symbol aus dem
  <i className="legacy-icon-badge-layout-small sm" aria-hidden="true"/> -Menü in die obere Navigationsleiste verschoben
...
Sie können die neuesten Versionshinweise im Hilfecenter aufrufen. Auf das Hilfecenter können Sie von Domo aus zugreifen, wenn Sie in der Navigationsleiste oben auf <i className="icon-question-circle sm" aria-hidden="true" /> klicken.
...
Ihr Feedback können Sie aus Domo heraus übermitteln (<i className="legacy-icon-badge-layout-small sm" aria-hidden="true"/> ****> Feedback****). Alternativ können Sie eine E-Mail an [product.feedback@domo.com](mailto:product.feedback@domo.com "product.feedback@domo.com") senden.
