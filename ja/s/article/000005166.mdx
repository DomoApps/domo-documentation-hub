...
excerpt: "Jupyter ワークスペース内で SSH キーを設定し、GitHub リポジトリを作成して標準的な Git 操作で更新をプッシュする方法を説明します。"
---
...
* [JupyterワークスペースとGitHubでリポジトリを作成する](#jupyterワークスペースとgithubでリポジトリを作成する)
...
5. 次の手順に従って、GitHubでリポジトリを作成します。このリポジトリに、Jupyterワークスペースファイルをプッシュできます。
   ...
   3. このリポジトリに関連付けられているSSH URLは、リポジトリのランディングページの **［Quick setup］** セクションで **［SSH］** を選択すると確認できます。このSSH URLは、 後のステップ で必要になります。
