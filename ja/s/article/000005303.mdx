...
excerpt: "Workbench Enterprise を実装し、必要条件、許可、Docker および RabbitMQ の設定を整えてマルチユーザー、ウェブベース、マルチプラットフォームの Workbench ジョブを運用します。"
---
...
リバースプロキシを使用してHTTPS経由でアクセスする場合は、443:8080を使用します。リバースプロキシの設定方法については、こちらを参照してください。
