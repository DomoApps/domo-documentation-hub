...
excerpt: "Magic ETL の SQL タイルで使用できる SQL 式の一覧と、Magic on Cloud Compute での利用可否をリファレンスとして提供します。"
---
...
Magic ETL DataFlowの作成中にSQLタイルでこれらの式を使用する方法については、 [こちら](/ja/s/article/360044876874#sqlタイル) を参照してください。
