...
excerpt: "Domo の Marketo Writeback コネクターを設定し、Domo のデータを Marketo のリードオブジェクトにエクスポートする手順を説明します。"
---
