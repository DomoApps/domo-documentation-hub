...
excerpt: "Domo の Google Gmail コネクターを設定して Gmail 受信トレイのデータを取り込む方法と、新規 DataSet 作成時に必要なサービスアカウントキー認証への移行について説明します。"
---
