...
excerpt: "Domo の Google Contacts コネクターを設定し、サービスアカウントキー認証を使用して連絡先データを DataSet に取り込みます。"
---
