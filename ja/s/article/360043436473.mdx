...
excerpt: "Box Advanced コネクターを設定し、複雑なヘッダーやカスタム区切り文字を含む Box 上のデータファイルを Domo に取り込みます。"
---
