...
1. Workbenchで、左側のアイコンバーにある <InlineImage src="/images/domocons/database.svg" /> をクリックします。
...
10. ペインの上部にある <i className="icon-save" aria-hidden="true" /> をクリックして、変換を保存します。
...
2. 画面左の <img src="/images/kb/ka05w00000123qa-00N5w00000Ri7BU-0EM5w000005vPKM.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> アイコンをクリックします。

   <Frame><img alt="" src="/images/kb/ka05w00000123qa-00N5w00000Ri7BU-0EM5w000005vPKJ.png"/></Frame>
...
8. 完了したら、**[適用]** をクリックします。
9. ペインの上部にある <i className="icon-save" aria-hidden="true" /> をクリックして、変換を保存します。
