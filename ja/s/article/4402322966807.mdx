...
このガイドでは、Snowflakeに精通しているユーザー向けに、読み取り/書き込み機能の設定や[OAuthの設定方法](#oauth)など、SnowflakeをCloud Amplifierに登録する方法を説明します。
...
8. **［OAuthを設定］**で、OAuthでユーザーを個別に認証できるようにスイッチを切り替えます。後述の「[DomoのOAuthを設定する](#domooauth)」を参照してください。
...
実稼働ワークロードの準備が整い、既存の機能的なウェアハウスを使用することと、Domo統合用の新しいウェアハウスを設定することのどちらがよいかを検討している場合は、Cloud Amplifierによる最適化についての [Domoブログの投稿](https://www.domo.com/blog/how-to-optimize-data-warehouse-strategy-with-cloud-amplifier/) <img src="/images/kb/ka0Vq00000001FR-00N5w00000Ri7BU-0EMVq0000000XDh.jpg" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> を参照してください。
...
こちらの [Snowflakeのドキュメント <img src="/images/kb/ka0Vq00000001FR-00N5w00000Ri7BU-0EMVq0000000XDh.jpg" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/>](https://docs.snowflake.com/ja/user-guide/key-pair-auth) のすべての指示に従います。パスフレーズが、キーペアの作成に使用したパスフレーズと一致し、ALTER USERステートメントが正常に実行されたことを確認します。

### このページのトップへ

### トラブルシューティング

Cloud AmplifierとSnowflakeの統合で問題が発生した場合、以下の情報が役立つ可能性があります。 [Domoサポート](https://domo-support.domo.com) [<img src="/images/kb/ka0Vq00000001FR-00N5w00000Ri7BU-0EMVq0000000XDh.jpg" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/>](https://docs.snowflake.com/ja/user-guide/key-pair-auth) にリクエストを送信することもできます。
