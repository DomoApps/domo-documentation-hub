---
title: "Datasets API"
permalink: "35115c5c48927-datasets-api"
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/query-with-sql"
/>
...
This endpoint supports read-only SELECT queries only. Statements that modify data — including INSERT, UPDATE, DELETE, and MERGE — are not supported and will not execute.

To ingest or update data in a dataset, use the Streams API instead.
</Note>
...
| sql | String | Yes | A read-only SQL SELECT statement to execute. Only SELECT queries are supported. Non-SELECT statements (INSERT, UPDATE, DELETE, MERGE, etc.) are not supported on this endpoint. |
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/dataset-access-list"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/revoke-dataset-access"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/get-metadata"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/create-upload-session"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/create-stream"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/get-stream"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/update-stream"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/stream-execution-history"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/execute-dataset-stream"
/>
**Method**: `POST`  
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/create-dataset-tag"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/share-dataset"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/remove-user-from-dataset"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/remove-multiple-users"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/upload-csv-part"
/>
**Method**: `PUT`  
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/commit-and-index-upload"
/>
**Method**: `PUT`
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/get-data-versions"
/>
**Method**: `GET`  
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/get-partition-list"
/>
**Method**: `GET`  
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/search-partition-list"
/>
**Method**: `POST`  
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/data-version-list-from-magic"
/>
**Method**: `POST`  
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/delete-data-version"
/>
**Method**: `DELETE`
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/delete-partition-tag"
/>
**Method**: `DELETE`
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/index-dataset"
/>
**Method**: `POST`
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/create-dataset-copy"
/>
**Method**: `POST`  
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/get-dataset-schema"
/>
**Method**: `GET`  
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/alter-dataset-schema"
/>
**Method**: `POST`  
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/get-cards-for-dataset"
/>
**Method**: `GET`  
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/index-dataset-progress"
/>
**Method**: `GET`
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/datasets-api/change-dataset-properties"
/>
**Method**: `PUT`
