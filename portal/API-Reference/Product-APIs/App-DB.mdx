...
| unwind         | String  | Optional | Comma-separated list of properties to unwind (flattens nested arrays).                                                  |
| orderby        | String  | Optional | Alias of the aggregation to order by, followed by `ascending` or `descending`.                                          |
