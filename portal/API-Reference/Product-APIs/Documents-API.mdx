---
title: Documents API
permalink: b939448cde9d5-file-sets-api
---

This API reference documents the endpoints for managing Document Collections and Files in Domo. These endpoints allow you to upload, download, query, and manage Files and Document Collections programmatically.
...
**Method:** `GET`  
**Endpoint:** `/api/files/v1/filesets/{documentCollectionId}/path?path={filePath}`

**Path Parameters:**

- `documentCollectionId` (String, required): The ID of the Document Collection.

**Query Parameters:**

- `path` (String, required): The path to the File within the Document Collection.
...
```js
fetch(
  "https://{instance}.domo.com/api/files/v1/filesets/{documentCollectionId}/path?path={filePath}",
  {
    method: "GET",
    headers: {
...
url = 'https://{instance}.domo.com/api/files/v1/filesets/{documentCollectionId}/path?path={filePath}'
...
**Method:** `GET`  
**Endpoint:** `/api/files/v1/filesets/{documentCollectionId}/files/{fileId}`
...
```js
fetch(
  "https://{instance}.domo.com/api/files/v1/filesets/{documentCollectionId}/files/{fileId}",
  {
    method: "GET",
    headers: {
      "X-DOMO-Developer-Token": "<your-token-here>",
...
url = 'https://{instance}.domo.com/api/files/v1/filesets/{documentCollectionId}/files/{fileId}'
...
**Method:** `GET`  
**Endpoint:** `/api/files/v1/filesets/{documentCollectionId}/files/{fileId}/download`
...
```js
fetch(
  "https://{instance}.domo.com/api/files/v1/filesets/{documentCollectionId}/files/{fileId}/download",
  {
    method: "GET",
    headers: {
      "X-DOMO-Developer-Token": "<your-token-here>",
...
url = 'https://{instance}.domo.com/api/files/v1/filesets/{documentCollectionId}/files/{fileId}/download'
...
- Returns the Document Collection contents as a download (binary/text stream).
...
**Method:** `POST`  
**Endpoint:** `/api/files/v1/filesets/{documentCollectionId}/query`

**Description:** Queries the Files and directories within a Document Collection using a search query.

**Path Parameters:**

| Parameter | Type   | Required | Description           |
| --------- | ------ | -------- | --------------------- |
| documentCollectionId | String | Yes      | The ID of the Document Collection |
...
fetch(`https://{instance}.domo.com/api/files/v1/filesets/${documentCollectionId}/query`, {
  method: "POST",
  headers: {
    "X-DOMO-Developer-Token": "<your-token-here>",
    "Content-Type": "application/json",
...
url = 'https://{instance}.domo.com/api/files/v1/filesets/{documentCollectionId}/query'
data = {
    'query': 'quarterly sales data',     # Text to search for in files
    'directoryPath': 'reports/quarterly', # Optional: Limit search to specific directory
    'topK': 5,                           # Optional: Maximum number of results to return
...
**Method:** `POST`  
**Endpoint:** `/api/files/v1/filesets/{documentCollectionId}/files`
...
fetch(
  "https://{instance}.domo.com/api/files/v1/filesets/{documentCollectionId}/files",
  requestOptions,
)
  .then((response) => response.json())
  .then((result) => console.log(result))
...
url = 'https://{instance}.domo.com/api/files/v1/filesets/{documentCollectionId}/files'
...
**Method:** `POST`  
**Endpoint:** `/api/files/v1/filesets/{documentCollectionId}/files/search`

**Description:** Lists Files and directories within a Document Collection, optionally filtered by directory path or other criteria.
...
> **Note:** The Filter, FieldSort, and DateFilter objects have the same structure as in the Search Document Collections endpoint.

<Tabs>
<Tab title="Javascript">

```js
// Example 1: List all files in Document Collection
fetch(
  `https://{instance}.domo.com/api/files/v1/filesets/${documentCollectionId}/files/search`,
  {
    method: "POST",
    headers: {
      "X-DOMO-Developer-Token": "<your-token-here>",
...
fetch(
  `https://{instance}.domo.com/api/files/v1/filesets/${documentCollectionId}/files/search?directoryPath=reports&limit=20`,
  {
    method: "POST",
    headers: {
      "X-DOMO-Developer-Token": "<your-token-here>",
...
# Example 1: List all files in Document Collection
url = f'https://{{instance}}.domo.com/api/files/v1/filesets/{documentCollectionId}/files/search'
data = {}
...
# Example 2: Advanced search with directory path and filters
url = f'https://{{instance}}.domo.com/api/files/v1/filesets/{documentCollectionId}/files/search?directoryPath=reports&limit=20'
...
```js
fetch(
  "https://{instance}.domo.com/api/files/v1/filesets/{documentCollectionId}/path?path=rules.txt",
  {
    method: "DELETE",
    headers: {
      "X-DOMO-Developer-Token": "<your-token-here>",
...
url = 'https://{instance}.domo.com/api/files/v1/filesets/{documentCollectionId}/path?path=rules.txt'
...
**Description:** Searches for Document Collections in your Domo instance using filters and criteria.
...
```js
// Example 1: List all Document Collections (empty search)
fetch(
...
fetch("https://{instance}.domo.com/api/files/v1/filesets/search", {
  ...
  body: JSON.stringify({
    ...
    // Filter Document Collection by name containing "Marketing"
    filters: [
      {
        field: "name",
        value: ["Marketing"],
    ...
    // Filter Document Collection created between two dates
    dateFilters: [
      {
        field: "created",
...
| Parameter        | Type    | Required | Description                                                            |
| ---------------- | ------- | -------- | ---------------------------------------------------------------------- |
| name             | String  | Yes      | The name of the Document Collection                                                |
| accountId        | Integer | No       | The account ID to associate (nullable)                                 |
| connectorContext | Object  | No       | Connector context for the Document Collection (nullable). ConnectorContext Object. |
| description      | String  | No       | Description for the Document Collection                                            |
...
fetch("https://{instance}.domo.com/api/files/v1/filesets", {
  ...
  body: JSON.stringify({
    ...
    description: "A sample Document Collection for demonstration purposes.",
...
**Method:** `GET`
**Endpoint:** `/api/files/v1/filesets/{documentCollectionId}`
...
```js
fetch("https://{instance}.domo.com/api/files/v1/filesets/{documentCollectionId}", {
  method: "GET",
  headers: {
    "X-DOMO-Developer-Token": "<your-token-here>",
    "Content-Type": "application/json",
...
url = 'https://{instance}.domo.com/api/files/v1/filesets/{documentCollectionId}'
...
| Parameter   | Type   | Required | Description                     |
| ----------- | ------ | -------- | ------------------------------- |
| name        | String | No       | The new name for the Document Collection    |
| description | String | No       | The new description for Document Collection |
...
fetch("https://{instance}.domo.com/api/files/v1/filesets/{documentCollectionId}", {
  ...
  body: JSON.stringify({
    name: "Updated Document Collection Name", // Optional: New name for the Document Collection
