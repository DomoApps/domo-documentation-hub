---
title: Workflows API
permalink: kspv2orr3oi30-workflows-product-api
---
...
If you are looking to hit a workflow from a Domo App, see the [App Framework API Reference for Workflows](/portal/API-Reference/app-framework-apis/Workflows-API) and the [guide on how to hit a workflow from a Domo App](/portal/Apps/App-Framework/Guides/hitting-a-workflow).

If you are unfamiliar with how to authenticate against Product APIs, [please see this overview page](/portal/API-Reference/overview).

For more background on Workflows, check out the [Knowledge Base for an overview](/s/article/000005108?language=en_US).
...
Cancels an in progress Workflow. If you are unfamiliar with how to authenticate against Product APIs, [please see this overview page](/portal/API-Reference/overview).
