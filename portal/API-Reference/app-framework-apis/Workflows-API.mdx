---
title: Workflows API
permalink: 1ay1akbc787jg-workflows-api
---
...
If you haven't leveraged Workflows from within Apps before, checkout [the guide on hitting a Workflow from an App](/portal/Apps/App-Framework/Guides/hitting-a-workflow), which details how to configure your `manifest.json` file and wire up Workflows to your app.
