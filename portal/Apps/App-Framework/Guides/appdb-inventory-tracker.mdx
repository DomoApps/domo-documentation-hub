...
There are three ways to update documents: the [single-document replace](/api-reference/appdb-api/replace-document), the [bulk upsert](/api-reference/appdb-api/upsert-documents-in-bulk), or the [multi-document partial update](/api-reference/appdb-api/partially-update-documents).
...
See [Partially Update Documents](/api-reference/appdb-api/partially-update-documents) for all supported operators.
