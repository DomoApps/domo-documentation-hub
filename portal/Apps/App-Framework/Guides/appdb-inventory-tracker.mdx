...
There are three ways to update documents: the [single document replace](/api-reference/appdb-api/update-document), the [bulk upsert](/api-reference/appdb-api/upsert-documents-in-bulk), or the [multi-document partial update](/api-reference/appdb-api/partially-update-documents).
