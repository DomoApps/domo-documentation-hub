...
Load the contents of this [sample data](/images/dev/s3.amazonaws.com/development.domo.com/wp-content/uploads/2017/06/27151228/galatic-sales-sample.csv) into a new Domo Webform and note the new ID.
