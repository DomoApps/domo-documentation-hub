...
You can learn more about [setting up Code Engine functions in Domo's Knowledge Base](/s/article/000005173?language=en_US).

In order to be able to hit a Code Engine function from an app, you need to add a `packageMapping` definition to your app's [manifest file](/portal/Apps/App-Framework/Guides/manifest) and then wire up a code engine function to the app in the wiring screen. To be able to test your code engine function locally, please also make sure that you have [configured your app with a `proxyId`](/portal/Apps/App-Framework/Guides/manifest#getting-a-proxyid-advanced).
...
![Selecting a function named awesomeFunction](/images/dev/stoplight.io/images/Screenshot-2024-02-13-at-2.30.40-PM.png)
...
![Unconfigured wiring screen asking you to select a package to map to awesomeFunction](/images/dev/stoplight.io/images/Screenshot-2024-02-13-at-2.31.16-PM.png)

Next, click "Select Package". This will open a modal to choose your package.

![Select package modal showing a list of packages to choose from](/images/dev/stoplight.io/images/Screenshot-2024-02-13-at-2.32.29-PM.png)

Finally, choose your package, version, function, and map input parameters.

![Filled out wiring screen](/images/dev/stoplight.io/images/Screenshot-2024-02-13-at-2.34.02-PM.png)
