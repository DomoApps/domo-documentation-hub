...
Sometimes developers confuse Typescript types (like "Number") with the column types that are supported for Domo DataSets. Instead, use “DOUBLE”, “LONG”, or “DECIMAL” types. Please refer to the [AppDB API](/portal/API-Reference/app-framework-apis/AppDB-API#defining-collections-in-the-manifest) documentation for the list of supported column types.
