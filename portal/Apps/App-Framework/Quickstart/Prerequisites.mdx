---
title: Prerequisites
permalink: 67dwgt0v6q3w9-quickstart
---

This Quick Start guide will give you all the tools you need to get up and running building Custom Apps on Domo.

To build apps on top of Domo, you'll need a Domo Instance and Developer Access to that Instance. _If you already have a Domo instance be sure you have logged in._
...
- A <a href="https://www.domo.com/start/developer">Domo account</a> (you can't
    publish your app without one)
