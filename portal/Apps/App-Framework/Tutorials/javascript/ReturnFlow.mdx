...
You can check out complete code examples of the Return Flow app **[here](https://github.com/DomoApps/returns-walkthrough/tree/final)**.

![Screen Shot 2023-08-06 at 3.57.12 PM.png](/images/dev/stoplight.io/images/Screen-Shot-2023-08-06-at-3.57.12-PM.png)

Before beginning make sure you've completed the [QuickStart](/portal/Apps/App-Framework/Quickstart/Prerequisites), which includes setup and installation
and the prerequisites for building on the Domo App Platform.
...
![Screen Shot 2023-08-06 at 4.15.45 PM.png](/images/dev/stoplight.io/images/Screen-Shot-2023-08-06-at-4.15.45-PM.png)

I've named my DataSet `Return Flow Sample`, but you can name yours whatever you'd like.

![Screen Shot 2023-08-06 at 4.25.52 PM.png](/images/dev/stoplight.io/images/Screen-Shot-2023-08-06-at-4.25.52-PM.png)
...
![Screen Shot 2023-08-06 at 4.38.28 PM.png](/images/dev/stoplight.io/images/Screen-Shot-2023-08-06-at-4.38.28-PM.png)
...
![Screen Shot 2023-08-06 at 4.42.44 PM.png](/images/dev/stoplight.io/images/Screen-Shot-2023-08-06-at-4.42.44-PM.png)
...
![Screen Shot 2023-08-06 at 4.56.16 PM.png](/images/dev/stoplight.io/images/Screen-Shot-2023-08-06-at-4.56.16-PM.png)

Go ahead and click on that link and then create a new Card.

![Screen Shot 2023-08-06 at 4.58.27 PM.png](/images/dev/stoplight.io/images/Screen-Shot-2023-08-06-at-4.58.27-PM.png)
...
![Screen Shot 2023-08-06 at 4.58.58 PM.png](/images/dev/stoplight.io/images/Screen-Shot-2023-08-06-at-4.58.58-PM.png)
...
The [`domo.js` library](/portal/Apps/App-Framework/Tools/domo-js) provides a number of useful functions for interfacing with Domo, including the `domo.get` call that is included in our `app.js` file by default.
...
This starter code uses Domo's [Data API](/portal/API-Reference/app-framework-apis/Data-API) to get the first 100 records from our DataSet with the alias `returns`.
...
![Screen Shot 2023-08-07 at 12.41.41 PM.png](/images/dev/stoplight.io/images/Screen-Shot-2023-08-07-at-12.41.41-PM.png)
...
![Screen Shot 2023-08-07 at 12.44.33 PM.png](/images/dev/stoplight.io/images/Screen-Shot-2023-08-07-at-12.44.33-PM.png)
...
![Screen Shot 2023-08-07 at 12.55.12 PM.png](/images/dev/stoplight.io/images/Screen-Shot-2023-08-07-at-12.55.12-PM.png)
...
![ReturnFlow ProxyID.gif](/images/dev/stoplight.io/images/ReturnFlow-ProxyID.gif)
...
![ReturnFlow Card Mapping.gif](/images/dev/stoplight.io/images/ReturnFlow-Card-Mapping.gif)
...
![Screen Shot 2023-08-07 at 1.37.50 PM.png](/images/dev/stoplight.io/images/Screen-Shot-2023-08-07-at-1.37.50-PM.png)
...
![Screen Shot 2023-08-07 at 1.53.44 PM.png](/images/dev/stoplight.io/images/Screen-Shot-2023-08-07-at-1.53.44-PM.png)
...
![Screen Shot 2023-08-07 at 3.28.38 PM.png](/images/dev/stoplight.io/images/Screen-Shot-2023-08-07-at-3.28.38-PM.png)
...
![ReturnFlow Add Comment.gif](/images/dev/stoplight.io/images/ReturnFlow-Add-Comment.gif)
...
![Screen Shot 2023-08-07 at 4.00.25 PM.png](/images/dev/stoplight.io/images/Screen-Shot-2023-08-07-at-4.00.25-PM.png)
...
![Screen Shot 2023-08-07 at 4.03.03 PM.png](/images/dev/stoplight.io/images/Screen-Shot-2023-08-07-at-4.03.03-PM.png)
...
![Screen Shot 2023-08-07 at 4.28.14 PM.png](/images/dev/stoplight.io/images/Screen-Shot-2023-08-07-at-4.28.14-PM.png)
