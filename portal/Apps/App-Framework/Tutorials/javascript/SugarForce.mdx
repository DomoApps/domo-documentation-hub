...
This tutorial will walk you through building the “SugarForce” app. Before beginning make sure you've completed the [Quick Start](/portal/Apps/App-Framework/Quickstart/Prerequisites), which includes setup and installation and the prerequisites for building on the Domo App Platform.
...
You can check out complete code examples of the SugarForce app **[here](https://github.com/DomoApps/sugarforce)**.

<iframe
  className="w-full aspect-video rounded-xl"
  src="https://player.vimeo.com/video/430153930?app_id=122963"
...
<Frame>
  ![setup](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-setup-1.png)
</Frame>
...
<Frame>
  ![step-2-1.png](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-step-2-1.png)
</Frame>
...
<Frame>
  ![step-2-2.png](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-step-2-2.png)
</Frame>

#### Additional resources

For more examples on how to create complex queries of your data refer to the [Data Queries samples guide](/portal/Apps/App-Framework/Guides/querying-data).
...
```javascript
const customColors = ['#002159', '#03449E', '#0967D2', '#47A3F3', '#BAE3FF'];
...
<Frame>
  ![step3.1](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-step-3-1.png)
</Frame>
...
<Frame>
  ![step-4-1.png](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-step-4-1.png)
</Frame>

You can also find these designs by going to the “Asset Library” from your “More” menu

<Frame>
  ![step-4-2.png](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-step-4-2.png)
</Frame>
...
<Frame>
  ![Sugarforce-New-1.png](/images/dev/web-assets.domo.com/blog/wp-content/uploads/2022/06/Sugarforce-New-1.png)
</Frame>
...
<Frame>
  ![Sugarforce-New-2.png](/images/dev/web-assets.domo.com/blog/wp-content/uploads/2022/06/Sugarforce-New-2.png)
</Frame>
...
<Frame>
  ![Sugarforce-New-3.png](/images/dev/web-assets.domo.com/blog/wp-content/uploads/2022/06/Sugarforce-New-3.png)
</Frame>
...
<Frame>
  ![step-4-5.png](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-step-4-5.png)
</Frame>
...
<Frame>
  ![Step4-7.png](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-Step4-7.png)
</Frame>

#### Additional Resources

For additional information on using AppDB, refer to the [AppDB API Reference Guide](/portal/API-Reference/app-framework-apis/AppDB-API).
...
The [Files API](/portal/API-Reference/app-framework-apis/Files-API) gives you the ability to handle files in a Domo app. Let users upload a file by adding the following to `opportunities.js`
...
In this example, the Files API is receiving a multipart upload based on the File object passed in as the argument `file`. It will return a promise that yields a file ID which we'll store in AppDB to access these attachments later.
...
<Frame>
  ![step-5-1.png](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-step-5-1.png)
</Frame>

<Frame>
  ![step-5-2.png](/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-step-5-2.png)
</Frame>
