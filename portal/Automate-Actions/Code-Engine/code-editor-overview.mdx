---
title: Code Editor
permalink: 7ee46a3107052-code-editor-overview
---
...
For the full permission model including the API values behind each UI label, see [Permissions and Sharing](./concepts/permissions-and-sharing).
...
The test run's execution result follows the same shape that external callers receive. See [Functions and Types](./concepts/functions-and-types) for the input/output type system, and the [Code Engine API reference](/portal/API-Reference/Product-APIs/Code-Engine) for the full execution response shape.
