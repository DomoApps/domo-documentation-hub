...
<strong>Note: </strong>You can move on to other steps before completing this step,
but icons are required before you submit your connector for publishing.

<Frame>
  ![User-Icon](/images/dev/s3.amazonaws.com/development.domo.com/wp-content/uploads/2017/03/10161752/UserIcon.png)
</Frame>
...
Here is an example of writing authentication code for an API that uses <strong>username and password</strong>. For a detailed description of the different methods, see the [Configure Authentication](/portal/Connectors/Custom-Connectors/configure-authentication) section. For code examples, see [Examples](/portal/Connectors/Custom-Connectors/examples).
...
<Frame>
  ![User-Auth](/images/dev/web-assets.domo.com/blog/wp-content/uploads/2022/02/UserAuth.png)
</Frame>
...
If you would like the ability for users to provide custom parameters that you can use when making your API calls, click <strong>Enable Advanced Mode</strong>. See [configure Reports](/portal/Connectors/Custom-Connectors/configure-reports) for instructions on how to use this feature. For code examples, see [Examples](/portal/Connectors/Custom-Connectors/examples).

<Frame>
  ![User-Reports](/images/dev/s3.amazonaws.com/development.domo.com/wp-content/uploads/2017/03/10162606/UserReports.png)
</Frame>
...
See [Process Data](/portal/Connectors/Custom-Connectors/process-data) for more detailed instructions. For code examples, see [Examples](/portal/Connectors/Custom-Connectors/examples).

<Frame>
  ![User-Data](/images/dev/s3.amazonaws.com/development.domo.com/wp-content/uploads/2017/03/11112751/UserData1.png)
</Frame>
...
<ul>
  ...
  <li>
    ...
    <em>yyyy-MM-dd'T'HH:mm:ss</em>.
  </li>
  <li>
    When adding a row, remember to call <em>datagrid.endRow()</em> when then row
    is complete.
  </li>
  <li>
...
1. Click **SEND TO DOMO** to view the 
...
<Frame>
  ![User-Data-2](/images/dev/s3.amazonaws.com/development.domo.com/wp-content/uploads/2017/03/10173244/UserData2.png)
</Frame>
...
<Frame>
  ![User-Publish](/images/dev/s3.amazonaws.com/development.domo.com/wp-content/uploads/2017/03/11133551/UserPublish.png)
</Frame>
...
See [Publish Connector](/portal/Connectors/Custom-Connectors/publish-connector) for more detailed instructions and information on this process.
