...
![datasetview](/images/dev/s3.amazonaws.com/development.domo.com/wp-content/uploads/2017/08/04100006/DataSetView.png)
...
<ul>
  <li>
    Automate external processes to push smaller sets data that occasionally need
    to be updated into Domo data pipeline
  </li>
  <li>
    Export aggregated and transformed Domo data for statistical analysis or any
    need
  </li>
  <li>
    Create user and group access to data within a DataSet through API's
    Personalized Data Permission (PDP) policies
  </li>
  <li>
    Automate external processes to manage DataSets and update intervals based on
    retrieving DataSets update information
  </li>
  <li>
    Utilize Upsert operations to insert or update an existing record in a single
    call
  </li>
</ul>
...
- [Import and Export Data](/portal/Connectors/api-connections/import-and-export-data)
