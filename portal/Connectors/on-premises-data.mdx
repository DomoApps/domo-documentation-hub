---
title: On-Premises Data
permalink: cb2e07663deaf-on-premises-data
---
...
The Workbench Developer Platform uses Dynamic-Link Library (DLL) that can be built
in your .NET Framework language and IDE of choice and then installed into Workbench
...
<img
  class="aligncenter wp-image-115"
  src="/images/dev/web-assets.domo.com/miyagi/images/product/product-feature-dev-portal-wokbench5-ui.png"
  alt="plugin manager screen"
/>
...
- [Connecting to Data Using Workbench 5](/s/article/360042932614?language=en_US)
- [Workbench 5 FAQs](/s/article/360043437373?language=en_US)
- [Common Workbench errors](/s/article/360042932614?language=en_US)
