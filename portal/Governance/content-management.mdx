---
title: 'Organize, manage, and share content to other users in Domo using the Page API'
permalink: e138903b113ee-organize-manage-and-share-content-to-other-users-in-domo-using-the-page-api
...
<Frame>
  ![](/images/s3.amazonaws.com/development.domo.com/wp-content/uploads/2017/08/09100910/PageVisuals.png)
</Frame>
...
<ul>
  <li>
    <a
      href="https://knowledge.domo.com/Administer/Controlling_Access_in_Domo"
      target="_blank"
      rel="noopener"
    >
  ...
  <li>
    <a
      href="https://domohelp.domo.com/hc/en-us/articles/360043439153-Specifying-Default-Overview-Content-for-Users"
      target="_blank"
      rel="noopener"
    >
  ...
  <li>
    <a
      href="https://knowledge.domo.com/Optimize/Filtering_Data/02Applying_Page-Level_Filters"
      target="_blank"
      rel="noopener"
    >
...
Once a page is created, you can continue to programmatically update it's content
and access.
...
This code creates a page via the [Page](/portal/gcl6cvkh1x5nk-page-api) API:
