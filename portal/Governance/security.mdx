...
Once you create the group, store the id value to group name in your own database to utilize when adding users with the [User](/portal/v91hopqk7ki3b-user-api) API or applying data permissions inside with the [Personalized Data Permission Policy (PDP)](/portal/Governance/pdp) API.
