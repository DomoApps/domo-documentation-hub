...
<Frame>
  ![](/images/dev/s3.amazonaws.com/development.domo.com/wp-content/uploads/2017/07/03123012/UserProfile.png)
</Frame>
...
<Info>
**Note**
In order to follow this Quickstart you will need to obtain an [access token](/portal/uc9ls4li6ny8s-embed-token-api#quickstart) or you can leverage any of [Domo's SDKs](/portal/Getting-Started/sdks) which will also handle authentication.
</Info>
