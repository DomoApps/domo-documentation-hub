...
<Note>
**Note**
You will need to be sure you have publishing to the Domo Appstore enabled for you. If you don't see the **+** icon in the left navigation bar contact us at [appsubmissions@domo.com](mailto:appsubmissions@domo.com) to have it turned on.
</Note>
...
<Note>
**Note**
When submitting cards, custom charts, enterprise apps, and services you skip this step and go directly to [Name and Info](#name-and-info).
</Note>
