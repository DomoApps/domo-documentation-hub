...
permalink: 600e2b5914564-domo-appstore
---
...
<Info>
**Note**
The ability to publish content is available by request. If you'd like to submit content to publish in Domo's Appstore, send an email with your name and instance URL to [appsubmissions@domo.com](mailto:appsubmissions@domo.com).
</Info>
...
<iframe
  ...
  src="https://player.vimeo.com/video/390832478"
...
1. Ensure that your app meets all the [Appstore Requirements](/portal/Partner-Developers/Domo-Marketplace/marketplace-requirements) before submitting it to the Appstore.
...
- **Enterprise App.** Publish a set of custom functionality built on top of [Domo's App Dev Framework](/portal/Apps/App-Framework/Welcome).
...
- [Appstore Submission Requirements](/portal/Partner-Developers/marketplace-requirements)
- [Appstore Submission Information](/portal/Partner-Developers/marketplace-submission)
