...
permalink: da7996a8b2338-building-an-app-overview
---
...
they make? How can I make those decisions easier, faster, and more accurate?
...
is my website traffic?” The former drives the user (and your content) toward an action.
...
you to focus using the metrics that will have the most value and drive action.
...
a good experience beginning with their first use of your app and beyond.
...
App visualizations are powered by datasets that reside in Domo. One of the first steps to building an app is getting data. This [guide](/portal/Partner-Developers/Guides/getting-data-overview) on getting data will walk you through some of the fundamental tools and features to acquire and transform data.
...
Gain ultimate flexibility and develop your own custom visualizations using HTML, CSS, JavaScript, and just about any web technology. [Learn More](/portal/Apps/App-Framework/Welcome))

## 4. Publish to the Domo Appstore

Apps can be shared with the entire Domo Appstore Ecosystem, which allows all Domo users the ability to download and populate the app with their own data. [Learn More](/portal/Partner-Developers/Domo-Marketplace/overview)
