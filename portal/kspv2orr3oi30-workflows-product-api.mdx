...
If you are looking to hit a workflow from a Domo App, see the [App Framework API Reference for Workflows](/portal/1ay1akbc787jg-workflows-api) and the [guide on how to hit a workflow from a Domo App](https://developer.domo.com/portal/81056f6209bfc-start-a-workflow-from-an-app).

If you are unfamiliar with how to authenticate against Product APIs, please see this overview page.
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/workflows-api-product/start-a-workflow"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/workflows-api-product/cancel-a-workflow"
/>
...
<Card
  ...
  title="Playground"
  icon="code"
  href="/api-reference/workflows-api-product/change-workflow-permissions"
/>
