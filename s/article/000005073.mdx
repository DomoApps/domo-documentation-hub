...
1. Hover over the top right corner of the app until
   <i className="icon-wrench-fill" aria-hidden="true" /> <i className="icon-chevron-down" aria-hidden="true" /> **Card options** displays floating over the other map controls.

   <Frame><img alt="card options over controls.png" src="/images/kb/ka05w0000012A9f-00N5w00000Ri7BU-0EM5w000006wFwI.jpg"/></Frame>

2. Select <i className="icon-wrench-fill" aria-hidden="true" /> <i className="icon-chevron-down" aria-hidden="true" /> **Card options** > **Edit Card**. The card editor opens.
