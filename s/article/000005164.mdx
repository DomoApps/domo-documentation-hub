---
title: "Attributes"
excerpt: "Configure attributes to drive dynamic groups and dynamic Personalized Data Permissions based on user profile data from your IdP or admins."
---
...
Custom (non-system) attributes can be used in both dynamic groups and dynamic PDP policies as long as they're managed. See the details above for how to configure an attribute as [managed](#managed-attributes). Learn about [Personalized Data Permissions (PDP)](/s/article/360042934614).
</Accordion>
...
Attributes are only editable when they are not being used to drive group membership and PDP rules. See [Attribute Management](#attribute-management) above for more information.
</Accordion>
