...
To learn more, see Jupyter Workspaces.
...
[Governance Toolkit: Observability Metrics](/s/article/8275510785559).

**Triggered Reports**

With Triggered Reports, you can create jobs that send Scheduled reports based off of DataSet updates and alerts.
