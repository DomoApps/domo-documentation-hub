...
This article explains how to set up a Databricks Cloud Integration in Domo for read-only or read/write access, add Databricks tables as DataSets, and configure OAuth and write-back so you can build cards, alerts, and Magic ETL DataFlows on Databricks data.
