...
<Note>**Note:** If used, RabbitMQ encrypts all communication between the Control Center and the nodes. Only one RabbitMQ is required. If you have hundreds of nodes, you may consider linking multiple RabbitMQ instances to avoid overloading.</Note>
...
1. From the main nav, select **More**>**Admin**.****   
   The Admin Settings display.
2. Under **Authentication**, select **Workbench Enterprise**.  
...
3. Enter the URL(s) for your Workbench Enterprise instance so that you can use OAuth for secure access.
   ...
   <Frame>![enter urls.jpg](/images/kb/0EM5w000006w4dZ.jpg)</Frame>
4. Select **Generate Key**.  
   The key displays in the **Key** field.
5. Select **Copy** to copy the key to your clipboard.  

   <Frame>![copy key.jpg](/images/kb/0EM5w000006w4de.jpg)</Frame>
...
Run the following Docker commands with the new file directory inserted in the highlighted section below. When running Docker images on an ARM architecture, you will use the tag `arm-latest`:
...
If you want to use a reverse proxy and access it via HTTPS, use 443:8080. See how to [configure a reverse proxy](#configure-a-reverse-proxy) below.
...
<Frame>![one time setup.jpg](/images/kb/0EM5w000006w5i1.jpg)</Frame>

# Log In

On the Workbench Enterprise login page, select **Login With Domo**.

<Frame>![Login.jpg](/images/kb/0EMVq000000kJm1.jpg)</Frame>

# Configure Your First Node

<Note>**Note:** Nodes currently work on Windows and Linux. This section contains instructions for configuration in each.</Note>
...
3. Locate the node and select **Trust**to enable Workbench Enterprise to run jobs on the node.  
   ...
   <Frame>![trust node.jpg](/images/kb/0EMVq000000kv3J.jpg)</Frame>
...
2. Select **New Shared Credentials** > **Database** to open the creation modal.
   ...
   <Frame>![new database credentials.jpg](/images/kb/0EMVq000002Hd5R.jpg)</Frame>
3. Enter the values for the shared credential in the **Database** modal.

   <Frame>![database NEW.jpg](/images/kb/0EMVq000000kKJu.jpg)</Frame>
...
2. In Workbench Enterprise, go to <img alt="workbench admin option.jpg" src="/images/kb/0EMVq0000038Ptx.jpg" style={{width: 25, height: 26, display: 'inline', verticalAlign: 'start', margin: '0'}}/> **Admin** > **Workbench Import**.  
     

   <Frame>![workbench import.jpg](/images/kb/0EMVq0000038Q0P.jpg)</Frame>
...
After following the steps to [configure your first job](#configure-your-first-job), do the following:

1. Inside Workbench Enterprise, select **Jobs** in the left navigation.
2. In the jobs list, locate the job you want to run.
3. Select <img src="/images/kb/0EM5w000006w5jx.jpg" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> **More** > **Execute**.
...
1. Find and select your job in the jobs list.  
   ...
   <Frame>![job.jpg](/images/kb/0EMVq0000038goN.jpg)</Frame>
2. In the **Schedule** tab of the job details, check the box labeled **Watch for changes** in the **Basic Schedule** OR **Advanced Schedule** tab.  
   ...
   <Frame>![watch for changes.jpg](/images/kb/0EMVq0000038Z0T.jpg)</Frame>
   ...
   <Frame>![Screenshot 2024-10-08 at 2.59.51 PM.jpg](/images/kb/0EMVq0000038aRB.jpg)</Frame>

<Tip>**Tip:** Learn how to [launch Workbench Enterprise jobs with third-party tools](/s/article/000005587).</Tip>
