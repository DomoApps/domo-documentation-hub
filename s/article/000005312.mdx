...
4. Select **Connect Amazon Redshift** to start creating a new integration (see the [integration setup instructions](#create-an-amazon-redshift-integration-in-domo)).
