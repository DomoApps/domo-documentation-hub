...
excerpt: "Configure the Azure Data Lake Gen2 OAuth Writeback Connector to push Domo DataSets to Azure Data Lake Storage Gen2."
---

## Intro

Azure Data Lake Storage is Microsoft's optimized storage solution for big data analytics workloads. A fundamental part of Data Lake Storage Gen2 is the addition of a hierarchical namespace to Blob storage. Use this connector to integrate data from Azure storage into Domo for creating visual insights on the data.
