...
<Frame><img alt="image chart.jpg" src="/images/kb/ka0Vq0000004eBl-00N5w00000Ri7BU-0EMVq000003fadh.jpg"/></Frame>
---
...
Use the chart properties to construct an image URL. For example, if your data only contains a column for the ID, you must provide the URL prefix/suffix. See [Customize Image Charts](#customize-image-charts) for more information about the prefix/suffix.
