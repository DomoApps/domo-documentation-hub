...
excerpt: "Relocate or rename Cloud Amplifier tables from the DataSet Details view using the Schema Picker to simplify governance for Domo administrators."
---
