...
* [Anthropic](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/overview) <svg role="img" aria-label="Anthropic" viewBox="0 0 24 24" fill="currentColor" style={{height: '1.1em', width: '1.1em', display: 'inline', verticalAlign: '-0.15em', margin: '0'}}><path d="M17.3041 3.541h-3.6718l6.696 16.918H24Zm-10.6082 0L0 20.459h3.7442l1.3693-3.5527h7.0052l1.3693 3.5528h3.7442L10.5363 3.5409Zm-.3712 10.2232 2.2914-5.9456 2.2914 5.9456Z" /></svg>
* [OpenAI](https://platform.openai.com/docs/guides/text?api-mode=responses#prompt-engineering) <Icon icon="openai" iconType="brands" aria-label="OpenAI" />
* [AWS](https://aws.amazon.com/what-is/prompt-engineering/) <Icon icon="aws" iconType="brands" aria-label="AWS" />
