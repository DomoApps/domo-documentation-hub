---
title: "Domo AI Pro"
excerpt: "Domo AI Pro overview covering advanced AI capabilities, consumption-based pricing, AI credits, and token usage by model."
---
...
Learn how to use the [Magic ETL text generation tile](/s/article/000005741#text-generation-tile).

#### Magic ETL Sentiment Analysis Tile

Use the sentiment analysis tile to automatically classify text (reviews, social media, surveys) as positive,
negative, or neutral. It enables businesses to monitor brand reputation in real-time, improve customer service 
by identifying frustrated users, and analyze trends for better decision-making within Magic ETL workflows.

*   Each run consumes one operation plus tokens based on data volume.

#### Magic ETL Classification Tile

Use the classification tile to categorizes data (text, images, files) into predefined classes within Magic ETL workflows.
