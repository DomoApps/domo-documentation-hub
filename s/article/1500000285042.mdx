...
The SAP HANA plugin also supports end-to-end trace. For more info please see End-to-end tracing section.
...
1. Launch hdbsetup.exe in HDB_CLIENT_WINDOWS_X86_64. The
...
1. Click <img src="/images/kb/ka05w00000123rn-00N5w00000Ri7BU-0EM5w000005vPLz.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> in the left-hand icon bar.
2. Click
   **Plugins** in the **More** pane. (If you do not see this pane, click <img src="/images/kb/ka05w00000123rn-00N5w00000Ri7BU-0EM5w000005vPLv.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> to expand it.) The **Plugin Manager** opens.
3. Under
...
1. Click the
<img src="/images/kb/ka05w00000123rn-00N5w00000Ri7BU-0EM5w000005vPM0.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> icon in the left-hand icon bar.
