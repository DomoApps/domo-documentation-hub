...
<table border="1" cellpadding="1" cellspacing="1" data-aura-rendered-by="33:207;a">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td colspan="1" rowspan="1">
        <p> Enter the directory name using the following examples. </p>
    ...
    <tr>
      ...
      <td colspan="1" rowspan="1">
        {" "}
        Select the file encoding. By default, <span></span>
        <b> UTF-8 </b> is selected.{" "}
      </td>
    </tr>
    <tr>
      <td colspan="1" rowspan="1">
...
<Accordion title="Where can I find my client ID, client secret, and tenant ID?">
