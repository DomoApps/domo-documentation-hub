...
excerpt: "Use the Sprinklr V2 Connector with custom query reports to aggregate social media insights from Sprinklr into a Domo DataSet."
---

## Intro

The Domo Sprinklr V2 connector allows you to integrate data from your Sprinklr installation. This allows you to aggregate insights across multiple social media channels. The Domo Sprinklr V2 connector supports custom query reports. Use this connector to instantly connect, visualize, and get insights from your Sprinklr data. For more information about the Sprinklr API, visit their website. ([https://dev.sprinklr.com](https://dev.sprinklr.com "https://dev.sprinklr.com") ).
...
On the first run, the Connector will integrate data corresponding to the filter 'Start Date' to 'End Date'.  After that, the Connector will set the 'Start Date' to the next day after it was last run, and will use the current date as the value for the 'End Date'.
