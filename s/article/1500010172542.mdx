...
1. From the navigation header, go to **Dashboards**. Open the dashboard you wish to edit in mobile view.
2. Select the **Dashboard Options** <img src="/images/kb/ka0Vq000000EPWP-00N5w00000Ri7BU-0EM5w000005vOY9.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> menu icon and select **Edit Dashboard**.
3. From the **Desktop** menu, select **Mobile**. The dashboard's mobile view displays.
4. (Conditional) Drag and drop cards to swap locations, adjust borders, and change card sizes. When the dashboard is viewed from a mobile device, the new mobile formatting displays.
...
4. Hover over the card you want to hide, select
   <img src="/images/kb/ka0Vq000000EPWP-00N5w00000Ri7BU-0EM5w000005vOY0.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> **Mobile Options** and <img src="/images/kb/ka0Vq000000EPWP-00N5w00000Ri7BU-0EM5w000005vOXy.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> **Hide Card.**
...
When the dashboard is viewed from a mobile device, the hidden cards will not display.
  ...
  <Frame><img alt="Screen_Shot_2021-04-16_at_1.37.53_PM.png" src="/images/kb/ka0Vq000000EPWP-00N5w00000Ri7BU-0EM5w000005vOYB.png"/></Frame>
...
2. Select the **Dashboard Options** <img src="/images/kb/ka0Vq000000EPWP-00N5w00000Ri7BU-0EM5w000005vOY9.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> menu icon and select **Edit Dashboard**.
3. From the **Desktop** menu, select **Mobile**. The dashboard's mobile view displays.
4. Select **Hidden Cards <img src="/images/kb/ka0Vq000000EPWP-00N5w00000Ri7BU-0EM5w000005vOYA.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/>**
5. In the **Hidden Cards** list, hover over the Card you want to unhide and select <img src="/images/kb/ka0Vq000000EPWP-00N5w00000Ri7BU-0EM5w000005vOXw.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> **Unhide.**
6. In the **Editing Dashboard** bar, select **Save.** The previously hidden card displays in mobile view.
...
**Can I drag appendix items onto a template while in mobile view?**

Just like the action of placing a card in the layout on web version but in the appendix section on mobile, you cannot drag appendix items into a template while in mobile view; this is because all items must stay in sync.
