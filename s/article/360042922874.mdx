...
You can access any of these resources from within Domo by clicking <i className="icon-question-circle" aria-hidden="true" /> in the top navigation bar. This opens a page with links to the Community Forum, Knowledge Base, Developer Portal, Video Library, and training apps.
...
1. In Domo, click
   <i className="icon-question-circle" aria-hidden="true" /> in the top navigation bar.
