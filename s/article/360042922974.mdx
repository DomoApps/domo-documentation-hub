...
excerpt: "Mark a SQL DataFlow as private during creation or editing to restrict edit access to the owner and Domo admins."
---
...
1. While creating or editing the DataFlow, select **Settings** to open the settings modal.
   ...
   <Frame><img alt="" src="/images/kb/ka0Vq000000DVPN-00N5w00000Ri7BU-0EMVq000007bRLN.jpg"/></Frame>
2. Go to the modal's **Privacy** tab and check the box labeled **Enable Privacy**.
     
   <Frame><img alt="" src="/images/kb/ka0Vq000000DVPN-00N5w00000Ri7BU-0EMVq000007bRTR.jpg"/></Frame>
...
DataFlows do not have their own separate edit-permission list. Edit access to a DataFlow is derived from access to the DataFlow's input DataSets: anyone who can access all of the input DataSets can open and edit the DataFlow. Enabling privacy overrides this by locking edit access to the owner and Domo admins, regardless of who can access the input DataSets.
...
<Note>
  **Note:** These steps cover SQL DataFlows.
  {/* [pm-input] Andrea Henderson — confirm whether Magic ETL DataFlows expose the same privacy lock and whether their edit access is derived from input-DataSet sharing in the same way. Synthesized from community forum reports; needs confirmation. */}
</Note>