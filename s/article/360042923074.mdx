...
excerpt: "View a DataFlow's version history in the Details view to track saved changes and restore previous versions as the current one."
---

## Intro

This article explains how to view a DataFlow's version history in the Details view to track saved changes and restore a previous version as the current one.
