...
excerpt: "Build a SQL DataFlow that calculates rolling-average values and snapshots for period-over-period comparisons in Domo cards."
---

## Intro

This article explains how to build a SQL DataFlow that calculates rolling-average values and creates snapshots for period-over-period comparisons in Domo cards.
