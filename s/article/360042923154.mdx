...
2. Click
   <i className="icon-dataflow" aria-hidden="true" /> in the left-hand navigation pane.
...
4. Mouse over the desired DataFlow then click
   <i className="icon-wrench" aria-hidden="true" /> to display a list of options. (You can also access this menu from the Details view for the DataFlow.)
