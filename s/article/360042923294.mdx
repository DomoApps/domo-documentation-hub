...
2. Click
   <img src="/images/kb/ka05w00000123RF-00N5w00000Ri7BU-0EM5w000005vOCU.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/>, then select **Remove**.
