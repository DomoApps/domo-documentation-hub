...
* A
  <img src="/images/kb/ka05w00000123RF-00N5w00000Ri7BU-0EM5w000005vOCS.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> icon appears on the bottom of the card, indicating the number of issues reported in this card.
...
1. In the card Details view, click the
   <img src="/images/kb/ka05w00000123RF-00N5w00000Ri7BU-0EM5w000005vOCS.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> icon on the card with an issue.
