...
excerpt: "Apply temporary Card Filters in a Visualization or Sumo Card Details view to analyze data without changing the saved chart."
---

## Intro

This article explains how to apply temporary Card Filters to Visualization and Sumo Cards in the Details view so you can analyze your data without changing the saved chart.
