...
<Note>
  ...
  *same* DataSet. However, calculations are *not* inherited when you drill to a *different* DataSet. For more information about Beast Mode, see [Create a Beast Mode Calculation](/s/article/360043429913).
  * You
