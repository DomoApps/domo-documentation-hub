...
2. Click
   <img src="/images/kb/ka05w00000123Qn-00N5w00000Ri7BU-0EM5w000005vOAc.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/>, then select **Edit Drill Path**.
