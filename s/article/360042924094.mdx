...
For more information, see [Settings Card Interactions](/s/article/360043428433 "Creating Domo Stories").
...
<Note>
  ...
  * Calculations you create using Beast Mode are inherited when you drill from one view to another using the *same* DataSet. When you drill to a *different* DataSet, the drill card references the parent card's Beast Modes rather than inheriting them, so you may see what appears to be a duplicate Beast Mode for each DataSet — one belongs to the parent card and the other is the reference available to the drill card. To avoid confusion, we recommend that you do *not* reuse Beast Mode names between the parent card and its drill cards. For more information about Beast Mode, see [Create a Beast Mode Calculation](/s/article/360043429913).
  * You
  *cannot* create Beast Mode calculations on any card in a Drill Path *except* the top-level card. Calculations created on any other cards in a drill path will disappear after they are saved.
  * You cannot create a Drill Path from a System page—
  **Overview**, **Favorites**, or **Shared**.
  ...
  * When adding a fiscal calendar as part of a drill path, the fiscal calendar selection in the child pages must be the same as that of the parent card; otherwise the drill path won't work. For more information, see
  [Using A Fiscal Calendar](/s/article/360042924254 "Using A Fiscal Calendar").
...
If PDP (Personalized Data Permissions) is enabled on a DataSet used in a drill layer, those policies are retained in the drill path. For example, if Brett, a member of the "Western Region" policy, goes to build a drill path on a PDP-affected card in which he is only allowed to see data for western states, his completed drill path will contain only information for those same states. For more information about PDP, see [Personalized Data Permissions (PDP)](/s/article/360042934614 "Personalized Data Permissions (PDP)").

For information about exploring existing drill path layers in a chart, see [Drilling into Data](/s/article/360042923994 "Drilling into Data").
...
2. Click
   <i className="icon-wrench sm" aria-hidden="true" />, then select **Edit Drill Path**.
...
4. (Optional) Select a different DataSet by doing the following:
   ...
   1. Click
      <img src="/images/kb/ka0Vq0000000shx-00N5w00000Ri7BU-0EM5w000005vOzV.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> next to the DataSet name.
...
<Frame><img alt="" src="/images/kb/ka0Vq0000000shx-00N5w00000Ri7BU-0EM5w000005vOzP.png"/></Frame>
...
<Frame><img alt="" src="/images/kb/ka0Vq0000000shx-00N5w00000Ri7BU-0EM5w000005vOzW.png"/></Frame>
...
<Frame><img alt="" src="/images/kb/ka0Vq0000000shx-00N5w00000Ri7BU-0EM5w000005vOzR.png"/></Frame>
...
<Frame><img alt="" src="/images/kb/ka0Vq0000000shx-00N5w00000Ri7BU-0EM5w000005vOzd.png"/></Frame>
...
<Frame><img alt="" src="/images/kb/ka0Vq0000000shx-00N5w00000Ri7BU-0EM5w000005vOzX.png"/></Frame>
## Use Case 2
...
<Frame><img alt="" src="/images/kb/ka0Vq0000000shx-00N5w00000Ri7BU-0EM5w000005vOzK.png"/></Frame>
The resulting Vertical Bar chart appears as follows:

<Frame><img alt="" src="/images/kb/ka0Vq0000000shx-00N5w00000Ri7BU-0EM5w000005vOze.png"/></Frame>
...
<Frame><img alt="" src="/images/kb/ka0Vq0000000shx-00N5w00000Ri7BU-0EM5w000005vOzT.png"/></Frame>
...
<Frame><img alt="" src="/images/kb/ka0Vq0000000shx-00N5w00000Ri7BU-0EM5w000005vOzg.png"/></Frame>
## Drill Between Maps
