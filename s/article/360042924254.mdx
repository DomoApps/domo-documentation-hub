...
2. Whether your fiscal year matches the actual year of the starting dates. For instance, if your year starts on October 1st, 2018, is it considered fiscal year 2018 or 2019?
...
For more information on how to contact Support, see [Technical Support](/s/article/360042922874).
...
1. Go to the **Analyzer** view of a card. For more information on how to do this, see [Opening Analyzer](/s/article/360042924054).
...
4. Save the card.
   ...
   <Frame>
     <img alt="Fiscal_Calendar.png" src="/images/kb/ka05w00000127j4-00N5w00000Ri7BU-0EM5w000005vOyQ.png" />
   </Frame>
