...
As an executive or manager of your organization, you may want to assign a team member to create and power up a Visualization Card. Domo provides a simple way to do this. You can choose the <i className="icon-plus sm" aria-hidden="true" /> **>** **Assign Card creation** option in a Page and assign a user in your Domo to power a Card. Domo then creates a *template* Visualization Card—a "dummy" Card not yet connected to a DataSet—and adds it to the same Page in the assigned user's Domo. The assigned user also receives a notification that he/she is responsible for powering and owning the Card. For more information about notifications, see [Creating an Alert for a Visualization Card](/s/article/360043430513 "Notifications and Alerts").
...
2. Click
   <i className="icon-plus sm" aria-hidden="true" />.
