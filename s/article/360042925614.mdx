...
excerpt: "Upload new file versions to a Doc Card from the Card Details view and restore earlier versions from the Versions panel."
---

## Intro

This article explains how to upload new file versions to a Doc Card from the Card Details view and restore earlier versions from the **Versions** panel.
...
3. (Conditional) If the **Versions** panel is closed, open it by clicking <img src="/images/kb/ka05w00000123TK-00N5w00000Ri7BU-0EM5w000005vOGp.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/>.
