...
excerpt: "Edit a Notebook Card from its Details view, or inline from the Page view when Domo Stories Dashboards are enabled."
---

## Intro

This article explains how to edit a Notebook Card from its Details view and inline from the Page view when Domo Stories Dashboards are enabled.
...
2. Mouse over the Notebook Card you want to edit and click the pencil icon. <img src="/images/kb/ka05w00000123Td-00N5w00000Ri7BU-0EM5w000005vOHl.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/>
