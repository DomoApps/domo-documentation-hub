...
excerpt: "Edit a project's name, team members, privacy, description, or due date, or delete the project from its details page."
---

## Intro

This article explains how to edit a project's name, team members, privacy, description, or due date, and how to delete a project from its details page.
...
3. Mouse over the arrow to the right of the project name to display the project menu.
   ...
   <Frame><img alt="project_menu_icon.png" src="/images/kb/ka05w00000123b2-00N5w00000Ri7BU-0EM5w000005vOd5.png"/></Frame>
