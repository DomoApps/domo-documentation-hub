...
excerpt: "Add custom task lists to a project workflow using the To-Do, In Progress, or Completed list types and reorder them as needed."
---

## Intro

This article explains how to add custom task lists to a project using the To-Do, In Progress, or Completed list types, and how to reorder and rename them.
