...
excerpt: "Edit a project task's name, description, owner, contributors, due date, project, and tags from its edit dialog."
---

## Intro

This article explains how to edit a project task's name, description, owner, contributors, due date, project, and tags from its edit dialog, and how to add comments and attachments to the task.
