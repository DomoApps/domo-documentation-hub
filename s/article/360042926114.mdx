...
excerpt: "Set the expected update frequency for a DataSet so Domo can warn you when actual updates fall behind schedule."
---

## Intro

This article explains how to set the expected update frequency for a DataSet so Domo can warn you when actual updates fall behind schedule.
...
3. Search for the DataSet you want, then view the details either by clicking the name or by clicking
   <i className="icon-wrench sm" aria-hidden="true" /> > **View Details**.<br/><br/>
