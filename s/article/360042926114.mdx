...
3. Search for the DataSet you want, then view the details either by clicking the name or by clicking
   <img src="/images/kb/ka05w00000123hf-00N5w00000Ri7BU-0EM5w000005vOsO.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> > **View Details**.<br/><br/>
