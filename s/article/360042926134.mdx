...
excerpt: "Export a DataSet from Domo as a Microsoft Excel or CSV file from its Details view in the Data Center."
---

## Intro

This article explains how to export a DataSet from Domo as a Microsoft Excel or CSV file from its Details view in the Data Center.
...
4. Click the ellipses icon
   <img src="/images/kb/ka0Vq00000013FB-00N5w00000Ri7BU-0EM5w000005vPWz.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> in the top right-hand corner of the screen, then select **Export data**.
