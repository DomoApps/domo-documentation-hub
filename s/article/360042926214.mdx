...
excerpt: "Manually run a DataSet to refresh its data, individually or in bulk, from the Data Center."
---

## Intro

This article explains how to manually execute (run) a DataSet to refresh its data, run DataSets individually or in bulk from the Data Center, and cancel a DataSet import.

---

{/* [pm-input] Phil Fuchs — confirm the Required Grants for executing DataSets; no Required Grants section exists. */}
...
4. Mouse over the row for the DataSet and click the
   <i className="icon-wrench sm" aria-hidden="true" /> icon.
5. Select **Run**.
