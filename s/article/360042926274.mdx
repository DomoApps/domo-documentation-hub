...
You can access the interface for adding Connector DataSets via the Appstore, the Data Center, or the <i className="icon-plus-circle" aria-hidden="true" /> menu.
...
1. Choose one of the following:
   ...
   * (Conditional) If you want to connect to data via the
     <i className="icon-plus-circle" aria-hidden="true" /> menu, do the following:

     1. Select
        <i className="icon-plus-circle" aria-hidden="true" /> **> Data**.
     2. Select
