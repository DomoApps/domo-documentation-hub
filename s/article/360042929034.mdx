...
excerpt: "Use Domo's Qubole Unload connector to import Qubole reports based on a specified query or script location into a DataSet."
---
...
This pane contains fields for entering credentials to connect to Qubole so you can integrate data. The following table describes what is needed for each field:
