...
<table border="1" cellpadding="1" cellspacing="1" data-aura-rendered-by="33:201;a">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td colspan="1" rowspan="1">
        {" "}
        <p>Select the report type: </p><table class='zebra-striped bordered'><tr><td><strong>Data</strong></td><td>Retrieves data.</td></tr><tr><td><strong>Assets</strong></td><td>Retrieves assets such as accounts, dimensions, levels, and related metadata.</td></tr></table>{" "}
      </td>
    </tr>
    <tr>
      <td colspan="1" rowspan="1">
    ...
    <tr>
      <td colspan="1" rowspan="1">
        {" "}
        Select Dimensions To Import{" "}
      </td>
      <td colspan="1" rowspan="1">
        {" "}
        Select the dimensions belonging to the selected sheet that you want to import.{" "}
      </td>
    </tr>
    <tr>
      <td colspan="1" rowspan="1">
      ...
      <td colspan="1" rowspan="1">
        {" "}
        Select the dimensions belonging to the select sheet that you want to import.{" "}
      </td>
    </tr>
    <tr>
      <td colspan="1" rowspan="1">
