  ...
  <tbody>
    ...
    <tr>
      ...
      <td colspan="1" rowspan="1">
        ...
        Select the report type:<br/>
        <b>Data:</b> Retrieves the data.<br/>
        <b>Assets:</b> Retrieves assets such as account, dimensions, levels and so on.
    ...
    <tr>
      ...
      <td colspan="1" rowspan="1">
        ...
        <p>
          ...
          and <span> 5 </span> for <b> Days Back to End At </b>, the report would contain
