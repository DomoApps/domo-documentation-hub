...
excerpt: "Use Domo's NetSuite Writeback Connector to create NetSuite records and sublists from a Domo DataSet using field and sublist mapping."
---
...
<table data-aura-rendered-by="33:195;a"><thead><tr><th colspan="1" rowspan="1"> Customer Name </th><th colspan="1" rowspan="1"> Subsidiary </th><th colspan="1" rowspan="1"> item </th><th colspan="1" rowspan="1"> quantity </th></tr></thead><tbody><tr><td colspan="1" rowspan="1"> Example Customer 1 </td><td colspan="1" rowspan="1"> HH Inc. </td><td colspan="1" rowspan="1"> Apple </td><td colspan="1" rowspan="1"> 1 </td></tr><tr><td colspan="1" rowspan="1"> Example Customer 1 </td><td colspan="1" rowspan="1"> HH Inc. </td><td colspan="1" rowspan="1"> Artichoke </td><td colspan="1" rowspan="1"> 5 </td></tr><tr><td colspan="1" rowspan="1"> Example Customer 2 </td><td colspan="1" rowspan="1"> HH Inc. </td><td colspan="1" rowspan="1"> Basketball </td><td colspan="1" rowspan="1"> 3 </td></tr><tr><td colspan="1" rowspan="1"> Example Customer 2 </td><td colspan="1" rowspan="1"> HH Inc. </td><td colspan="1" rowspan="1"> Bicycle </td><td colspan="1" rowspan="1"> 4 </td></tr><tr><td colspan="1" rowspan="1"> Example Customer 3 </td><td colspan="1" rowspan="1"> HH Inc. </td><td colspan="1" rowspan="1"> Clarinet </td><td colspan="1" rowspan="1"> 6 </td></tr><tr><td colspan="1" rowspan="1"> Example Customer 3 </td><td colspan="1" rowspan="1"> HH Inc. </td><td colspan="1" rowspan="1"> Camera </td><td colspan="1" rowspan="1"> 5 </td></tr><tr><td colspan="1" rowspan="1"> Example Customer 4 </td><td colspan="1" rowspan="1"> HH Inc. </td><td colspan="1" rowspan="1"> Desk </td><td colspan="1" rowspan="1"> 2 </td></tr><tr><td colspan="1" rowspan="1"> Example Customer 4 </td><td colspan="1" rowspan="1"> HH Inc. </td><td colspan="1" rowspan="1"> Dart </td><td colspan="1" rowspan="1"> 7 </td></tr></tbody></table>
...
3. Click
   **Manage Access Tokens** in the **Settings** box in the bottom left corner.
4. Click
   **New Access Token** and choose **Domo NetSuite Writeback Script**.
...
2. Find and click on
   **Domo NetSuite Writeback Script**. This can be done by looking through the results (which should be in alphabetical order) or by typing netsuiteWriteback.js into the **Script File** box at the top.
3. Click the
   **Deployments** tab.
...
Learn how to get your [Domo Client ID and Secret](/s/article/000005240#create-api-clients).
...
2. Choose your NetSuite record.
   ...
   For a full list of NetSuite records, check out the NetSuite record browser ([https://www.netsuite.com/help/helpcenter/en\_US/srbrowser/Browser2016\_1/script/record/account.html](https://www.netsuite.com/help/helpcenter/en_US/srbrowser/Browser2016_1/script/record/account.html "https://www.netsuite.com/help/helpcenter/en_US/srbrowser/Browser2016_1/script/record/account.html") ).
3. Configure your Field Mapping.
   ...
   * Add custom page size to avoid execution timeout:
      
      + Enter the custom page size to avoid execution timeout for the RESTLET script. The default value is 100 and you can enter any value between 1 to 200.
      + Note that reducing the page size count may increase the overall dataset execution time, moreover increasing the page size may cause **timeout errors** or **instruction count exceeded errors**.
...
## Supported Records and Transforms

The NetSuite Writeback connector creates standard NetSuite records that are available in the [NetSuite record browser](https://www.netsuite.com/help/helpcenter/en_US/srbrowser/Browser2016_1/script/record/account.html). Commonly used records include **Sales Order** and **Journal Entry**, both of which use sublists (line items) in addition to fields, as described in the [Multiple sublist entries](#multiple-sublist-entries) section above.

{/* [pm-input] Tasleema Lallmamode — provide the authoritative list of NetSuite record objects supported for writeback and the supported transform options, and confirm the status of the Case object and additional transform options (reported by forum users as feature requests). Synthesized from community forum reports; needs confirmation. */}
