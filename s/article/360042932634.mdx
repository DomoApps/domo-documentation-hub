...
2. Select
   <img src="/images/kb/ka05w00000123tU-00N5w00000Ri7BU-0EM5w000005vPQ5.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> **Accounts** (key icon) in the left navigation.
3. Select
   **Add Account** (plus icon). (If you do not see this icon, select <img src="/images/kb/ka05w00000123tU-00N5w00000Ri7BU-0EM5w000005vPQj.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> to expand the account listing pane.)
4. In the
...
8. Select
   <img src="/images/kb/ka05w00000123sv-00N5w00000Ri7BU-0EM5w000005vPOl.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> **Save** (floppy disk icon) to save your new account.
