...
excerpt: "Create a JSON DataSet job in Workbench 5 by specifying the transport type, data node, delimiter, and flattening options."
---

## Intro

This article explains how to create a JSON DataSet job in Workbench 5 by specifying the transport type, data node, delimiter, and flattening options.
...
1. Click the database button <i className="legacy-icon-database sm" aria-hidden="true" /> in the left-hand icon bar.
2. Click the plus button <i className="legacy-icon-plus sm" aria-hidden="true" /> in the top right corner of the jobs listing pane.
...
5. In the
   **Transport Type** menu, select **Local File Provider,** **External Process File Provider**, **FTP/SFTP File Provider**, or **JIRA Connection Provider**.
   ...
   <table class="mt-responsive-table"><thead><tr><th colspan="1" rowspan="1"><p><span class="info-box-icon"> Transport Method </span></p></th><th colspan="1" rowspan="1"><p><span class="info-box-icon"> Description </span></p></th></tr></thead><tbody><tr><td colspan="1" rowspan="1"><p><span class="info-box-icon"> Local File Provider </span></p></td><td colspan="1" rowspan="1"><p><span class="info-box-icon"> Lets you select a file from your machine or a network. </span></p></td></tr><tr><td colspan="1" rowspan="1"><p><span class="info-box-icon"> External Process File Provider </span></p></td><td colspan="1" rowspan="1"><p><span class="info-box-icon"> Lets you use a third-party application to pull data into Domo using a script. </span></p></td></tr><tr><td colspan="1" rowspan="1"><p><span class="info-box-icon"> FTP/SFTP File Provider </span></p></td><td colspan="1" rowspan="1"><p><span class="info-box-icon"> Lets you retrieve a file via FTP, SFTP (SSH-FTP), or FTPS (FTP-SSL) </span></p></td></tr><tr><td colspan="1" rowspan="1"><p> JIRA Connection Provider </p></td><td colspan="1" rowspan="1"><p> Lets you retrieve a file from a JIRA server using a JQL query. </p></td></tr></tbody></table>

6. In the
   **Reader Type** menu, select **JSON**.
7. In the
...
13. (Conditional) Do one of the following:
    ...
    * If you selected
      **JIRA Connection Provider** as your transport type...
      ...
      2. In the
         **Server URL** field, enter the URL where your company JIRA server is located.
      3. In the
...
15. In the
    **Data Source** field, enter the data node where you want to begin pulling JSON data.
      
    This should be an array of objects.
16. In the
    **Delimiter** field, enter the delimiter that should be inserted into the column name in flattened results.
17. In the
    **Flattening Options** menu, select the desired flattening option. Options are as follows:

    <table class="mt-responsive-table"><thead><tr><th colspan="1" rowspan="1"> Option </th><th colspan="1" rowspan="1"> Description </th></tr></thead><tbody><tr><td colspan="1" rowspan="1"><p> None </p></td><td colspan="1" rowspan="1"><p> Returns the unflattened JSON string. </p></td></tr><tr><td colspan="1" rowspan="1"><p> Deep </p></td><td colspan="1" rowspan="1"><p> Adds new rows for all nested objects. </p></td></tr><tr><td colspan="1" rowspan="1"><p> Wide </p></td><td colspan="1" rowspan="1"><p> Adds new columns for all nested objects. Only one row is returned. </p></td></tr></tbody></table>
