...
excerpt: "Create a QuickBooks DataSet job in Workbench 5 by selecting a report type and specifying options like fiscal year and date granularity."
---

## Intro

This article explains how to create a QuickBooks DataSet job in Workbench 5 by selecting a report type and specifying options such as fiscal year and date granularity.
