...
excerpt: "Build calculated columns in Workbench 5 DataSets using the Calculated Field Transform Editor and over 80 built-in functions."
---

## Intro

This article explains how to create calculated columns in Workbench 5 DataSets using the Calculated Field Transform Editor and its built-in functions.
...
9. Click
   **Apply** when finished.
10. Click the save icon <i className="icon-save sm" aria-hidden="true" /> at the top of the pane to save your transform.
