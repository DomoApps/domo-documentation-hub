...
excerpt: "Apply Filter transforms in Workbench 5 to include or exclude matching rows, optionally using regular expressions and null handling."
---

## Intro

This article explains how to apply Filter transforms in Workbench 5 to include or exclude matching rows, optionally using regular expressions and null handling.
