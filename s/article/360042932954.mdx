...
3. Copy and save the link in the
   **Webhook URL** field. (Note that you cannot change this field.)
   ...
   <Frame><img alt="Webhook URL_Details section" src="/images/kb/ka0Vq00000003qj-00N5w00000Ri7BU-0EMVq0000005kzt.jpg"/></Frame>
...
4. Fill out the fields to author the function from scratch:
   ...
   * Role – Select
     **Choose an existing role**. Work with your AWS administrator to make sure that there is a role appropriate for this function. The role needs to be able to read from Kinesis, write to CloudWatch (for logging), and make HTTPS calls.
     ...
     <Frame><img alt="Create Function_Author from Scratch" src="/images/kb/ka0Vq00000003qj-00N5w00000Ri7BU-0EMVq0000005lJF.jpg"/></Frame>
...
6. After the Lambda function has been created, add Kinesis as a trigger to it by selecting
   **Kinesis** from the menu on the left of the screen.
   ...
   <Frame><img alt="Add Trigger_Kinesis2Webhook" src="/images/kb/ka0Vq00000003qj-00N5w00000Ri7BU-0EMVq0000005lZN.jpg"/></Frame>
...
7. Configure the trigger by filling out the required fields. Generally, the default values are acceptable:
   ...
   * Activate Trigger – Make sure this box is checked.
     ...
     <Frame><img alt="Trigger Configuration" src="/images/kb/ka0Vq00000003qj-00N5w00000Ri7BU-0EMVq0000005laz.jpg"/></Frame>
...
12. Below the code window, add two environment variables:
    ...
    * WEBHOOK\_ENDPOINT
      ...
      <Frame><img alt="Environment Variables" src="/images/kb/ka0Vq00000003qj-00N5w00000Ri7BU-0EMVq0000005lcb.jpg"/></Frame>
