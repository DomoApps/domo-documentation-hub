...
excerpt: "Use the Google Maps Pinboard app to plot location-based metrics on a global map and compare performance across offices and territories."
---

## Intro

This article covers the Google Maps Pinboard app, which plots location-based metrics on a global map so you can compare performance across offices and territories.
