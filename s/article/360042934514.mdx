...
excerpt: "Hide the Remember me checkbox on the Domo login screen to require users to enter their username on every sign-in."
---

## Intro

This article explains how to disable username autocomplete on the Domo login screen by hiding the "Remember me" checkbox so users must enter their username on every sign-in.
