...
<Frame><img alt="getting_started_page.png" src="/images/kb/ka05w00000129uT-00N5w00000Ri7BU-0EM5w000005vOjK.png"/></Frame>
...
To access the Help Center, just click on the help icon <i className="legacy-icon-question-circle sm" aria-hidden="true"/> in the upper right corner of the screen.
