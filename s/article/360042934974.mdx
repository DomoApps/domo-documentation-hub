---
title: "2018 Release 9 | October"
excerpt: "October 2018 release notes covering Certified Content, data science and scripting actions in ETL, and related enhancements."
---
...
For more information, see [Certifying Content](/s/article/360043430613 "Certifying Content").
...
For more information, see [ETL Actions: Scripting](/s/article/360043427773 "ETL Actions: Data Science").

### Workbench 5 Beta Release

We are excited to announce that a brand new version of Workbench is going into an OPEN BETA release on October 23rd. This version will provide a cleaner, easier-to-navigate user interface and a **Home** screen that shows you the status of all of your jobs (shown below).

<Frame><img alt="workbench_5_rn.png" src="/images/kb/ka05w00000129tz-00N5w00000Ri7BU-0EM5w000005vOkF.png"/></Frame>
For more information, see [Connecting to Data Using Workbench 5](/s/article/360042932554 "Connecting to Data Using Workbench 5").
...
For more information, see [KPI Card Details View](/s/article/360042923934 "Card Details View Layout").
...
For more information, see [PDP and Alerts](/s/article/360042934634 "PDP and Alerts").
...
For more information, see [Creating a Custom Alert for a KPI Card](/s/article/360043430513 "Creating a Custom Alert for a KPI Card").
...
* To enable you to more quickly find the Domo University resources, videos, Knowledge Base articles, and Dojo content you need, the Domo Help Center icon has been moved out of the
  <i className="legacy-icon-badge-layout-small sm" aria-hidden="true"/> menu and into the top navigation bar.
...
For more information, see [DataFlow Schedules](/s/article/360042923034).
