...
For more information, see [Using the Domo Word Plugin](/s/article/360042933094 "Using the Domo Word Plugin").
...
* [Spark Line Graph](/s/article/360043429353 "Spark Line Graph")
* [Spark Bar Graph](/s/article/360043429333 "Spark Bar Graph")
...
For more information about all of these options, see [Properties for Maps](/s/article/360043429853 "Properties for Maps").
...
Feel free to reach out directly to [Support](/s/article/360042922874 "https://domo-support.domo.com/s/") where you can get one-on-one help with upgrading your Workbench instance to the latest version.
