...
3. In Workbench, click on the <img src="/images/kb/ka05w00000123s4-00N5w00000Ri7BU-0EM5w000005vPMM.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> icon in the bottom left corner of the screen.
