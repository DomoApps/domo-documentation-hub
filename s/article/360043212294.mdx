...
excerpt: "Schedule a Workbench 5 DataSet job to upload data to Domo on a basic or advanced schedule, when a file changes, or as part of a schedule group."
---

## Intro

This article explains how to schedule a Workbench 5 DataSet job on a basic or advanced update schedule, run it automatically when a local source file changes, and set up group schedules for job dependencies.
...
- A scheduled DataSet job sends data from the specified DataSet to Domo.  
   You can view the DataSet information in Domo by clicking**Data**. For more information, see [Data Center Layout](/s/article/360047553253).   
...
- You can receive an email report when a scheduled DataSet job runs. For more information, see [Setting Notifications in Workbench 5](/s/article/360043437333).
...
1. In the jobs listing in the **Jobs** pane, double-click on the DataSet job you want to set an update schedule for. <img alt="wb5_jobs_tab_list.png" src="/images/kb/0EM5w000005vPMU.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> 2. Click the **Schedule** subtab.  
...
1. In Workbench, click the <img alt="wb5_ellipsis_icon.png" src="/images/kb/0EM5w000005vPMK.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> icon in the toolbar on the left side of the screen.
...
6. Set the run order for the jobs.   
    You can move jobs up or down in the order by selecting them then clicking <img alt="wb5_group_scheduling_move_up.png" src="/images/kb/0EM5w000005vPMG.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> or 
