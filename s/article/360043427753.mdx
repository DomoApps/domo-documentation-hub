...
excerpt: "Configure the legacy Magic ETL Data Science tiles to run classification, regression, clustering, and forecasting algorithms on your data."
---
...
6. Indicate the number of times you want each row to be observed per time period.
   ...
   <Frame><img alt="Screen Shot 2022-11-16 at 3.19.41 PM.png" src="/images/kb/ka0Vq0000000yXF-00N5w00000Ri7BU-0EM5w000005vqxO.jpg"/></Frame>
...
5. Lastly, select either the
   Linear Regression or Random Forest algorithm. In this example, we will select Linear Regression.
