...
excerpt: "Edit a SQL DataFlow in the Data Center, configure input triggers, and choose whether to save, run, or save and close the updated DataFlow."
---

## Intro

This article explains how to edit an existing SQL DataFlow, configure input triggers to run it automatically, and save, run, or save and close your changes.
...
4. Click
   <img src="/images/kb/ka05w00000123i8-00N5w00000Ri7BU-0EM5w000005vOvH.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> on the right-hand side of the screen.
