...
excerpt: "Disable a DataFlow to stop powered DataSets and cards while keeping it intact, or delete it to remove the DataFlow from Domo entirely."
---

## Intro

This article explains how to disable a DataFlow, delete a single DataFlow, and delete multiple DataFlows at once.
...
4. Mouse over the desired DataFlow then click
   <img src="/images/kb/ka05w00000123RE-00N5w00000Ri7BU-0EM5w000005vOCa.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> to display a list of options.
