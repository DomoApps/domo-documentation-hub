...
excerpt: "Copy a DataFlow to create a staging environment for testing changes without affecting your production DataSets and cards in Domo."
---

## Intro

This article explains how to separate staging data from production data by copying a DataFlow, letting you test changes without affecting your production DataSets and cards.
