...
In the Analyzer, you choose the columns containing the data for your candlestick chart. For more information about choosing data columns, see [Applying DataSet Columns to Your Chart](/s/article/360043428713 "Applying DataSet Columns to Your Chart").
...
<Frame><img alt="" src="/images/kb/ka05w00000123pv-00N5w00000Ri7BU-0EM5w000005vPJE.png"/></Frame>
## Customizing candlestick charts

You can customize the appearance of a candlestick chart by editing its **Chart Properties**. For information about all chart properties, see Chart Properties.