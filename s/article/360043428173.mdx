...
excerpt: "Handle attribution windows from sources like Facebook and YouTube by combining a rolling replace DataSet with a daily appended historical DataSet."
---

## Intro

This article explains how to handle attribution windows from sources like Facebook and YouTube by combining a rolling replace DataSet with a daily appended historical DataSet.
