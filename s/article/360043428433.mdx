...
1. Select **Design Dashboard** in the <i className="icon-wrench sm" aria-hidden="true" /> menu in the top right corner of the Page.
...
1. Select **Convert to Standard Page** in the <i className="icon-wrench sm" aria-hidden="true" /> menu in the top right corner of the Page. (If the Domo Stories edit mode is open, you must first close it for this menu to appear.)
...
1. On the Page where you want to add header text, select **Edit Dashboard** in the <i className="icon-wrench sm" aria-hidden="true" /> menu in the top right corner of the Page.
2. Click and drag the
...
1. On the Page where you want to add a border, select **Edit Dashboard** in the <i className="icon-wrench sm" aria-hidden="true" /> menu in the top right corner of the Page.
2. Click and drag the
...
1. On the Page where you want to swap Cards, select **Edit Dashboard** in the <i className="icon-wrench sm" aria-hidden="true" /> menu in the top right corner of the Page.
...
1. On the Page where you want to replace a Card, select **Edit Dashboard** in the <i className="icon-wrench sm" aria-hidden="true" /> menu in the top right corner of the Page.
...
1. On the Page where you want to move a Card, select **Edit Dashboard** in the <i className="icon-wrench sm" aria-hidden="true" /> menu in the top right corner of the Page.
...
1. On the Page where you want to delete a Card, select **Edit Dashboard** in the <i className="icon-wrench sm" aria-hidden="true" /> menu in the top right corner of the Page.
...
1. On the Page where you want to delete a Domo Story, select **Edit Dashboard** in the <i className="icon-wrench sm" aria-hidden="true" /> menu in the top right corner of the Page.
...
1. On the Page where you want to edit or delete a header, select **Edit Dashboard** in the <i className="icon-wrench sm" aria-hidden="true" /> menu in the top right corner of the Page.
...
1. On the Page where you want to delete a border, select **Edit Dashboard** in the <i className="icon-wrench sm" aria-hidden="true" /> menu in the top right corner of the Page.
...
1. On the Page where you want to change a Story background color, select **Edit Dashboard** in the <i className="icon-wrench sm" aria-hidden="true" /> menu in the top right corner of the Page.
...
1. On the Page containing the Card you want to change the background color for, select **Edit Dashboard** in the <i className="icon-wrench sm" aria-hidden="true" /> menu in the top right corner of the Page.
...
1. On the Page containing the Card you want to show or hide elements for, select **Edit Dashboard** in the <i className="icon-wrench sm" aria-hidden="true" /> menu in the top right corner of the Page.
2. Locate the Card in the Page.
...
1. On the Page with the Card you want to open in another browser tab when clicked, select **Edit Dashboard** in the <i className="icon-wrench sm" aria-hidden="true" /> menu in the top right corner of the Page.
...
1. On the Page with the Card you want to configure interaction Filters for, select **Edit Dashboard** in the <i className="icon-wrench sm" aria-hidden="true" /> menu in the top right corner of the Page.
2. Mouse over the Card and click **Edit Content**.
3. Select **Change Interaction**.
...
1. On the Page with the Card you want to enable Drill in Place on, select **Edit Dashboard** in the <i className="icon-wrench sm" aria-hidden="true" /> menu in the top right corner of the Page.
2. Mouse over the Card and click **Edit Content**.
3. Select **Change Interaction**.
...
1. On the Page with the Card you want to link to Domo content, select **Edit Dashboard** in the <i className="icon-wrench sm" aria-hidden="true" /> menu in the top right corner of the Page.
2. Mouse over the Card and click **Edit Content**.
3. Select **Change Interaction**.
...
1. On the Page with the Card you want to link to external content, select **Edit Dashboard** in the <i className="icon-wrench sm" aria-hidden="true" /> menu in the top right corner of the Page.
2. Mouse over the Card and click **Edit Content**.
3. Select **Change Interaction**.
...
1. On the Page with the Card you want to disable interactions for, select **Edit Dashboard** in the <i className="icon-wrench sm" aria-hidden="true" /> menu in the top right corner of the Page.
2. Mouse over the Card and click **Edit Content**.
3. Select **Change Interaction**.
...
1. On the Page you want to change the background color of, select **Edit Dashboard** in the <i className="icon-wrench sm" aria-hidden="true" /> menu in the top right corner of the Page.
...
1. Select **Full Screen** in the <i className="icon-wrench sm" aria-hidden="true" /> menu in the top right corner of the Page.
...
1. On the Page you want to change the view of, select **Edit Dashboard** in the <i className="icon-wrench sm" aria-hidden="true" /> menu in the top right corner of the Page.
