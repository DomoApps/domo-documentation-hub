...
excerpt: "Permanently delete Cards from Domo using the page view, the Card Details view, or Admin Settings to remove them in bulk."
---

## Intro

This article explains how to permanently delete Cards from Domo using the page view, the Card Details view, or Admin Settings, including deleting multiple Cards at once.

---

{/* [pm-input] Chris Wright — confirm the Required Grants for deleting Cards from Domo; no Required Grants section exists. */}
...
1. Do one of the following:
   ...
   * In the Details view for the card, click <i className="icon-wrench sm" aria-hidden="true" />, then select **Delete**.
2. A dialog appears.
3. Click **Delete Card**.
