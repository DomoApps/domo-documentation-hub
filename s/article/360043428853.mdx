...
excerpt: "View the lineage of the DataSet powering a Card in Analyzer to see ancestor DataSets, DataFlow or DataFusion transformations, and pipeline health."
---

## Intro

This article explains how to view the lineage of the DataSet that powers a Card in Analyzer, inspect ancestor DataSets and their DataFlow or DataFusion transformations, and read the color coding that flags pipeline-health issues.
...
2. (Optional) If the Analyzer toolbar is not expanded near the top of the window, click
   <img src="/images/kb/ka05w00000123kI-00N5w00000Ri7BU-0EM5w000005vOyI.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> to expand it.
