...
1. On the Page where you want to create a Card, click the
   <i className="icon-plus sm" aria-hidden="true" /> icon in the upper right corner of the screen.
...
2. Click
   <i className="icon-database sm" aria-hidden="true" /> in the left-hand navigation pane to access existing DataSets.
