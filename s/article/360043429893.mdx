...
* an entry for the revision is added to the **History** tab in the card Details view.
  ...
  For more information about this view, see [Card Details View Layout](/s/article/360042923934 "Card Details View Layout").

For information about connecting cards to a different DataSet, see [Connecting Cards to a Different DataSet](/s/article/360043430653 "Connecting Cards to a Different DataSet").

For information about the Data Center, see [Workbench 5](/s/article/360042932554 "Data Center Layout").
...
2. Click
   <img src="/images/kb/ka05w00000123Qn-00N5w00000Ri7BU-0EM5w000005vOAb.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> (or <i className="icon-wrench sm" aria-hidden="true" /> in the Details view), then select **Connect / Update Data** from the menu.
...
4. Choose one of the following options:
   ...
   1. To use an existing DataSet...
      ...
      1. Click **Existing Data**.
         ...
         Once you have your results set, you can change the sort by clicking **Created Date (oldest to newest** **)** and then choosing the desired sort method and direction.
           <br/><br/>
         You can add or manage DataSets in the Data Center. For more information, see [Data Center Layout](/s/article/360047553253).
   ...
   2. To use a new Excel or CSV DataSet...
      ...
      3. (Optional) Edit the data if desired. For more information about editing chart data, see
         [Analyzer Overview](/s/article/360043428673 "KPI Card Building Part 2: The Card Builder").
...
2. Click
   <img src="/images/kb/ka05w00000123Qn-00N5w00000Ri7BU-0EM5w000005vOAb.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> (or in the Details view), then select **Connect / Update Data** from the menu.
...
You can update data that you have entered manually into a webform in Domo. For more information about uploading data using this form, see [Powering a Visualization Card with Data](/s/article/360043429873 "Powering a KPI Card with Data").
...
3. In the Details view, click
   <img src="/images/kb/ka05w00000123Qn-00N5w00000Ri7BU-0EM5w000005vOAb.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/>, then select **Edit Webform**.
