...
1. Open Buzz and find the conversation where you want the Bot to post.
   ...
   For more information about locating and opening conversations, see [Chatting in Buzz](/s/article/360042925574 "Chatting in Buzz").
2. Click the details icon (<img src="/images/kb/ka05w00000124CW-00N5w00000Ri7BU-0EM5w000005vOXZ.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> ) next to the conversation name to open the Details pane.
...
7. Follow the provided instructions for configuring the Bot.
   ...
   For more information about configuring NLQ for the Bot, see Understanding NLQ.
...
1. Open Buzz and find the conversation where the Bot has been added.
   ...
   For more information about locating and opening conversations, see [Chatting in Buzz](/s/article/360042925574 "Chatting in Buzz").
2. Click the details icon (<img src="/images/kb/ka05w00000124CW-00N5w00000Ri7BU-0EM5w000005vOXZ.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> ) next to the  conversation name.
...
5. Click the trash can icon
   <img src="/images/kb/ka05w00000123T0-00N5w00000Ri7BU-0EM5w000005vOFo.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/>.
