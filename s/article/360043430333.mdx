...
2. Click **Add Project**.
   ...
   <Tip>
     **Tip:** You can also open this dialog from anywhere in Domo by selecting <i className="icon-plus-circle" aria-hidden="true" /> in the app toolbar and selecting **Tasks > Project**.
