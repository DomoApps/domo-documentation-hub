...
You open The Data Warehouse by selecting **Data** in the toolbar at the top of Domo. The **Data Warehouse** tab is open by default. If you switch to another tab, you can return to the **Data Warehouse** tab by clicking <img src="/images/kb/ka05w00000124Sj-00N5w00000Ri7BU-0EM5w000005vPXO.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> in the left-hand navigation pane.

For more information about connecting to data in Domo, see [Data Center Layout](https://domo-support.domo.com/s/article/360047553253).
...
<Frame><img alt="" src="/images/kb/ka05w00000124Sj-00N5w00000Ri7BU-0EM5w000005vPXk.png"/></Frame>
