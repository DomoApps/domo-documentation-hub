...
This topic discusses how to submit requests for approval as well as approve them. For information about creating a request template, see [Approvals Layout](https://domo-support.domo.com/s/article/360042926014 "Creating a Request Form").
...
4. Do one of the following:
   ...
   * To *share access* to the request, click on the <img src="/images/kb/ka05w00000129vy-00N5w00000Ri7BU-0EM5w000005vNm2.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> and select **Edit observers**.
   * To *edit* the request, click on the <img src="/images/kb/ka05w00000129vy-00N5w00000Ri7BU-0EM5w000005vNm2.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/>, select **Edit request**, make your changes, then click **Save**.
   * To *request changes, delegate, or deny*, click on the <img src="/images/kb/ka05w00000129vy-00N5w00000Ri7BU-0EM5w000005vNm2.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/>, then select the action you wish to take.
       
     <Frame><img alt="Approval_Options.png" src="/images/kb/ka05w00000129vy-00N5w00000Ri7BU-0EM5w000005vNmA.png"/></Frame>