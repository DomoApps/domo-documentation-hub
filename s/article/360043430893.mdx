...
* Supported account types: Select
  **Accounts in any organizational directory (Any Azure AD directory – Multitenant) and personal Microsoft accounts**. Depending on the options available during app creation, this setting might also appear as **Any Entra ID tenant + Personal Microsoft accounts**.
...
During app creation, the setting might also appear as Any Entra ID tenant + Personal Microsoft accounts.

<Frame><img src="/images/kb/app-registration.png" width="700" height="400" /></Frame>
...
* Under Authentication -> Supported account types: Select Accounts in any organizational directory (Any Azure AD directory - Multitenant) and personal Microsoft accounts. Depending on the options available during app creation, this setting might also appear as Any Entra ID tenant + Personal Microsoft accounts."
