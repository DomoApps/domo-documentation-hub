...
| AI Readiness Details | Returns details about AI Readiness components. See [reference](#details-pane). |
...
| App Studio App Pages | Returns information about app pages inside of App Studio apps in your instance. See reference. |
| App Studio Apps | Returns information about App Studio apps in your instance. See reference. |
...
| Beast Modes | Returns information about all Beast Mode calculations in your instance. See [Beast Modes DataSet](#dataset-fields) below. |
...
| Card Loads | Returns information about cards and card loads in your Domo environment. See [Card Loads DataSet](#dataset-fields) below. |
...
| Document Collection Files | Detailed listing of each Document Collection |
| Document Collections | High level list of all Documents |
| Document Collections Connector History | Historical listing of connector updates |
...
| OKR Key Results (included with Domo Goals) | Returns information about the key results/metrics that have been created in Domo Goals. See OKR Key Results DataSet below. |
...
| Task Center | Returns information about task usage in your instance. Each row in the DataSet represents a specific task. See [Task Center DataSet](#dataset-fields) below for the full schema. |
...
| Workflows | Returns information about Workflows usage in your instance. See [Workflows DataSet](#dataset-fields) below for schema details. <Note>**Note:** A DataSet for the Workflows DomoStats report can only be created once per instance.</Note> |
...
This section provides field-by-field descriptions for specific DomoStats report DataSets. For additional reference, see [DomoStats reports DataSets](/s/article/000005946).

### Accounts

<Note>**Note:** Field-level schema for the Accounts report is forthcoming.</Note>

### Accounts with Permissions

<Note>**Note:** Field-level schema for the Accounts with Permissions report is forthcoming.</Note>
...
<Note>**Note:** Field-level schema for the Alerts report is forthcoming.</Note>

### App Studio App Pages
...
<Note>**Note:** Field-level schema for the AutoML Training Jobs report is forthcoming.</Note>
...
<Note>**Note:** Field-level schema for the Beast Modes used in Beast Modes report is forthcoming. Learn about [nested calculations](/s/article/000005307).</Note>

### Beast Modes used in Cards

<Note>**Note:** Field-level schema for the Beast Modes used in Cards report is forthcoming.</Note>

### Buzz

<Note>**Note:** Field-level schema for the Buzz report is forthcoming.</Note>

### Card Datasource

<Note>**Note:** Field-level schema for the Card Datasource report is forthcoming.</Note>
...
<Note>**Note:** Field-level schema for the Card Pages report is forthcoming.</Note>
...
<Note>**Note:** Field-level schema for the Cards report is forthcoming.</Note>

### Certified Content

<Note>**Note:** Field-level schema for the Certified Content report is forthcoming.</Note>
...
<Note>**Note:** Field-level schema for the Columns used in Beast Modes report is forthcoming.</Note>

### Connector Failures

<Note>**Note:** Field-level schema for the Connector Failures report is forthcoming.</Note>
...
<Note>**Note:** Field-level schema for the Credit Usage report is forthcoming.</Note>

### DataFlow Input DataSources

<Note>**Note:** Field-level schema for the DataFlow Input DataSources report is forthcoming.</Note>

### DataFlow Output DataSources

<Note>**Note:** Field-level schema for the DataFlow Output DataSources report is forthcoming.</Note>

### DataFlow Tags

<Note>**Note:** Field-level schema for the DataFlow Tags report is forthcoming.</Note>
...
<Note>**Note:** Field-level schema for the DataSet Access report is forthcoming.</Note>

### DataSet Schema

<Note>**Note:** Field-level schema for the DataSet Schema report is forthcoming.</Note>

### DataSet Tags

<Note>**Note:** Field-level schema for the DataSet Tags report is forthcoming.</Note>
...
<Note>**Note:** Field-level schema for the DataSets Execution Error report is forthcoming.</Note>
...
<Note>**Note:** Field-level schema for the Deleted DataSets report is forthcoming.</Note>

### Grants

<Note>**Note:** Field-level schema for the Grants report is forthcoming.</Note>

### Group Members

<Note>**Note:** Field-level schema for the Group Members report is forthcoming.</Note>

### Group Owners

<Note>**Note:** Field-level schema for the Group Owners report is forthcoming.</Note>

### Groups

<Note>**Note:** Field-level schema for the Groups report is forthcoming.</Note>

### Jupyter Workspace Usage

<Note>**Note:** Field-level schema for the Jupyter Workspace Usage report is forthcoming.</Note>

### Jupyter Workspaces

<Note>**Note:** Field-level schema for the Jupyter Workspaces report is forthcoming.</Note>

### ML Inference Jobs

<Note>**Note:** Field-level schema for the ML Inference Jobs report is forthcoming.</Note>

### Mobile Activity

<Note>**Note:** Field-level schema for the Mobile Activity report is forthcoming.</Note>
...
<Note>**Note:** Field-level schema for the Pages with Multiple Owners report is forthcoming.</Note>
...
<Note>**Note:** Field-level schema for the Publish report is forthcoming.</Note>

### Publish Event Logs

<Note>**Note:** Field-level schema for the Publish Event Logs report is forthcoming.</Note>

### Role Grants

<Note>**Note:** Field-level schema for the Role Grants report is forthcoming.</Note>

### Roles

<Note>**Note:** Field-level schema for the Roles report is forthcoming.</Note>

### Sandbox Commits

<Note>**Note:** Field-level schema for the Sandbox Commits report is forthcoming.</Note>

### Sandbox Content Mappings

<Note>**Note:** Field-level schema for the Sandbox Content Mappings report is forthcoming.</Note>

### Sandbox Promotions

<Note>**Note:** Field-level schema for the Sandbox Promotions report is forthcoming.</Note>

### Sandbox Repository Access

<Note>**Note:** Field-level schema for the Sandbox Repository Access report is forthcoming.</Note>

### Sandbox Repository Permissions

<Note>**Note:** Field-level schema for the Sandbox Repository Permissions report is forthcoming.</Note>

### Scheduled Report Recipients

<Note>**Note:** Field-level schema for the Scheduled Report Recipients report is forthcoming.</Note>

### Scheduled Reports

<Note>**Note:** Field-level schema for the Scheduled Reports report is forthcoming.</Note>
...
<Note>**Note:** Field-level schema for the Usage Metrics report is forthcoming.</Note>

### User Activity

<Note>**Note:** Field-level schema for the User Activity report is forthcoming.</Note>
...
<Note>**Note:** Field-level schema for the User Landing Resource report is forthcoming.</Note>

### Variables

<Note>**Note:** Field-level schema for the Variables report is forthcoming.</Note>

### Variables used in Beast Modes

<Note>**Note:** Field-level schema for the Variables used in Beast Modes report is forthcoming.</Note>

### View Inputs

<Note>**Note:** Field-level schema for the View Inputs report is forthcoming.</Note>
