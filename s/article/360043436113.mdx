...
* The certificate is also available at ***`/mnt/blumeta0/db2/ssl_keystore/rootCA.pem`*** inside the database container. You can extract it to tmp with this command: ***docker cp dashDB:/mnt/blumeta0/db2/ssl\_keystore/rootCA.pem /tmp***
