...
excerpt: "Configure Domo's Microsoft OneDrive for Business connector to import files from your OneDrive account into a DataSet using OAuth credentials."
---
...
|-------------|-------------|
| Download Shared File (Using SharingURL) | Downloads a shared file into Domo as a DataSet. You specify the file type, file or folder path, and other information. |
...
| Download File | Downloads a file into Domo as a DataSet. You specify the file type, file or folder path, and other information. |
...
| Shared Items — DEPRECATED | Lists items that are shared with the authenticated user. |
| Download Nested Children Shared File — DEPRECATED | Downloads a shared file from a nested children folder into Domo as a DataSet. You specify the folder name and the complete file path, along with other information. |
| Download Shared File (Search Endpoint) — DEPRECATED | Downloads a shared file into Domo as a DataSet. You specify the file type, file or folder path, and other information. |
| Download Shared File (SharedWithMe Endpoint) — DEPRECATED | Downloads a shared file into Domo as a DataSet. You specify the file type and file/folder or path, along with other information. |
| Download Children Shared File — DEPRECATED | Downloads a shared file from the children folder into Domo as a DataSet. You specify the file type, file or folder path, and other information. |

<Note>**Deprecated reports:** Use the **Download Shared File (Using SharingURL)** report instead of any of the deprecated reports listed above.</Note>
