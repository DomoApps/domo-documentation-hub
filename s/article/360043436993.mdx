...
excerpt: "Configure Domo's Microsoft OneDrive Writeback connector to export DataSet data to a specified OneDrive folder using OAuth credentials."
---
...
* The client ID and client secret associated with your Domo account. Learn how to get your <a href="https://www.domo.com/docs/s/article/000005240#create-api-clients">Domo Client ID and Secret</a>.
