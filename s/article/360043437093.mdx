...
excerpt: "Configure Domo's Snowflake Writeback connector to push DataSet data into a Snowflake database, with guidance to migrate from username and password auth before retirement."
---
...
<Note>**Note:** When creating a new client, if you utilize multiple Domo instances, make sure you're logged into the Developer Portal using the correct instance.</Note>

3. When creating the client, select ALL of the scopes. (Account, Audit, Buzz, Data, Dashboard, User, and Workflow.) <img alt="snowflake_writeback_new_client.png" src="/images/kb/0EM5w000005vO9S.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> 4. Click **Create**.
