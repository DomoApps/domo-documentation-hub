...
1. In Workbench, Click <InlineImage src="/images/domocons/database.svg" /> in the left-hand icon bar.
...
9. (Optional) If you want Workbench to generate an error if your Lookup Source is found to be missing, turn on
   **Error on Missing Lookup**.
   ...
   <Frame><InlineImage src="/images/domocons/database.svg" /></Frame>
...
10. Click **Apply**.
11. Click the save icon <i className="icon-save" aria-hidden="true" /> at the top of the pane to save your transform.
