...
excerpt: "Create a JIRA DataSet job in Workbench 5 using JIRA credentials and a JQL query to pull JIRA data into a DataSet."
---

## Intro

This article explains how to create a JIRA DataSet job in Workbench 5 using your JIRA credentials and a JQL query to pull JIRA data into a DataSet.
...
5. In the
   **Transport Type** menu, select **JIRA Connection Provider**.
6. In the
   **Reader Type** menu, select **JIRA**.
7. In the
