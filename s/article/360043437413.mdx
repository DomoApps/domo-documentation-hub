...
10. Click the save icon <i className="icon-save" aria-hidden="true" /> at the top of the pane to save your transform.
...
9. Click the save icon <i className="icon-save" aria-hidden="true" /> at the top of the pane to save your transform.
