...
excerpt: "Use the Search and Replace transform in Workbench 5 to substitute column values, including with regular expressions."
---

## Intro

This article explains how to use the **Search & Replace** transform in Workbench 5 to substitute column values, set a default replacement value, and build regular expressions with the Regular Expression Builder.
