...
3. Select _Domo ODBC Data Driver_ and click **Next**.
4. Click **Browse**.
...
9. Enter the Client ID and Client Secret.
   ...
   <Frame>
     <img
       alt="DDD-18.png"
       src="/images/kb/ka05w000001233k-00N5w00000Ri7BU-0EM5w000005vNvD.png"
     />
   </Frame>
   In this case, you must verify the installation, credentials, network, and
   accessibility to Domo APIs. Otherwise, a file will get created on successful
   verification.
   <Frame>
     <img
       alt="DDD-19.png"
       src="/images/kb/ka05w000001233k-00N5w00000Ri7BU-0EM5w000005vNvI.png"
     />
   </Frame>
...
1. In the ODBC Data Source Administrator, go to the **System DSN** tab.
   ...
   <Frame>
     <img
       alt="DDD-20.png"
       src="/images/kb/ka05w000001233k-00N5w00000Ri7BU-0EM5w000005vNvG.png"
     />
   </Frame>
2. Click **Configure**.
...
1. In the **Data** tab in Excel, select **New Query > From Other Sources > From ODBC**.
   <Frame>
     <img
       alt="DDD-22.png"
       src="/images/kb/ka05w000001233k-00N5w00000Ri7BU-0EM5w000005vNvO.png"
     />
   </Frame>
...
3. In **Advanced Options**, enter the "Select" query (see [Query Syntax](#h_d1ce073e-dcdf-46f3-a93c-d842b3c41b20 'DomoDataDriver') ), then click **OK**.
   <Frame>
     <img
       alt="DDD-23.png"
       src="/images/kb/ka05w000001233k-00N5w00000Ri7BU-0EM5w000005vNvH.png"
     />
   </Frame>
   ...
   <Frame>
     <img
       alt="DDD-24.png"
       src="/images/kb/ka05w000001233k-00N5w00000Ri7BU-0EM5w000005vNvN.png"
     />
   </Frame>
4. Click **Load** and data will be loaded after execution of the query.
   <Frame>
     <img
       alt="DDD-25.png"
       src="/images/kb/ka05w000001233k-00N5w00000Ri7BU-0EM5w000005vNvM.png"
     />
   </Frame>
...
- If you are using a DSN to connect, make sure you have configured the DSN correctly. For more details, see
  [Configure the DSN](#h_d0b95d1d-346e-4e26-93de-4368ee3e473a 'DomoDataDriver').
...
5.  Open the SQL Editor as shown below.
    <Frame>
      <img
        alt="DDD-33.png"
        src="/images/kb/ka05w000001233k-00N5w00000Ri7BU-0EM5w000005vNvL.png"
      />
    </Frame>
6.  Type in the query and execute as shown below.
    ...
    <Frame>
      <img
        alt="DDD-36.png"
        src="/images/kb/ka05w000001233k-00N5w00000Ri7BU-0EM5w000005vNvK.png"
      />
    </Frame>
    The DBeaver does not support long connection strings, so we cannot create a
    connection using Driver Name. If your tool supports long connection strings,
    you can use Driver Name instead of DSN. Please see [Connection
    Strings](#h_737894a0-3bb4-4605-aed1-645c5a0a7e31 "DomoDataDriver").
