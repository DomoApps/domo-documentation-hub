...
excerpt: "Export Sumo Card data to Microsoft Excel or CSV from the page or Details view, preserving sorts, filters, aggregations, and PDP policies."
---

## Intro

This article explains how to export Sumo card data to Microsoft Excel or CSV from the page or Details view, preserving sorts, filters, aggregations, and PDP policies.
...
Alternatively, you can export data from the Details view by selecting <img src="/images/kb/ka05w00000123Qp-00N5w00000Ri7BU-0EM5w000005vOAZ.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> **> Send/Export** in either **Column View** or **Pivot View** and selecting the desired option.