...
excerpt: "Email a Visualization Card from a dashboard or Details view to users, groups, or external addresses, preserving applied filters and PDP policies."
---

## Intro

This article explains how to email a Visualization Card from a dashboard or the Details view to users, groups, or external email addresses, preserving applied filters and PDP policies.
