...
excerpt: "Configure Google as a SAML identity provider for Domo so users can sign in with their Google credentials."
---
...
To complete the configuration process, you must be signed in as a super administrator in Google. (Learn more about [admin roles in Google <i className="icon-arrow-square-out sm" aria-hidden="true" />](https://support.google.com/a/answer/33325?hl=en).)
...
8. Edit the ****Service Provider Details**** as follows:
   ...
   * ****Entity ID —**** Paste the "Entity ID" copied in step 5.
     ...
     <Frame><img alt="GoogleIDP (1).png" src="/images/kb/ka0Vq0000001AIH-00N5w00000Ri7BU-0EMVq000001cu8f.jpg"/></Frame>
