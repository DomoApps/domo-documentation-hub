...
excerpt: "Use the Pipeline Velocity app to measure average days to close, conversion rate at each sales funnel stage, and improve pipeline performance."
---

## Intro

This article covers the Pipeline Velocity app, which shows the average days to close and conversion rate at each stage of your sales funnel to help sales leaders improve pipeline performance.
