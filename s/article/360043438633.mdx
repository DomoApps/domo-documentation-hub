...
excerpt: "Use the Sales Scorecard app to score individual sales reps across key performance metrics with custom views and filters for ranking and coaching."
---

## Intro

This article covers the Sales Scorecard app, which scores individual sales reps across the key performance metrics you choose and uses custom views and filters to help you rank and coach your team.
