...
4. To enable MFA, toggle the switch. By default, it is off.
   ...
   <Frame><img alt="MFA switch.jpg" src="/images/kb/ka0Vq0000003liL-00N5w00000Ri7BU-0EMVq000003JqZ3.jpg"/></Frame>
...
2. Select
   <img src="/images/kb/ka0Vq00000010pB-00N5w00000Ri7BU-0EMVq000001L7yn.jpg" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> **Settings**.
...
3. In the **General** tab, locate the **Security** section and check the box labeled **Enable multi-factor verification**. If you have a phone number listed on your profile, the access code is delivered via SMS message. If not, the access code is sent to the email address associated with your Domo account.
   ...
   <Frame><img alt="Screenshot 2023-06-08 at 10.57.12 AM.png" src="/images/kb/ka0Vq0000003liL-00N5w00000Ri7BU-0EM5w000006uxm1.jpg"/></Frame>
