---
title: "2018 Release 10 | November"
---
...
* Contact Technical Support by using `/support` in Buzz or by emailing [support@domo.com](mailto:support@domo.com).
* Reach out to your Domo Customer Success Manager or Technical Consultant.

For more information, see [Managing Roles](/s/article/360043438973 "Managing Roles - BETA").

## Getting Help

Need help with Domo? Click the help icon <i className="legacy-icon-question-circle sm" aria-hidden="true"/> in the top navigation bar to access a wealth of knowledge in the Help Center.
