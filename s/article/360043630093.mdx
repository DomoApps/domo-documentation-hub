...
To access your data using connectors, federated adapters (cloud-based/agentless), or Domo Cloud Integrations, Domo initiates network connections to your data sources. For these connections to succeed, Domo's IP addresses need to be allowed through any firewall or other security methods in place for your data sources.
...
To ensure consistent access to your data from Domo connectors, federated adapters, and/or Cloud Integrations, you must allow all of the IPs in the section below that corresponds to where your Domo instance is hosted. IPs are given using CIDR notation for convenience when working with AWS Security Groups and other network security systems.
...
```
18.98.166.192/28 (Includes all IPs from 18.98.166.192 through 18.98.166.207 inclusive).
```
...
<Note>
**Note:** For the Salesforce connector, IP allowlisting (whitelisting) must be configured for each user profile that will be used with Domo in Salesforce, not only at the org-level Network Access settings. Failing to allowlist the Domo IPs for the relevant profile(s) can cause the connector to return the error "There was a problem creating your account. Please try again later." For instructions, see Salesforce's documentation on **Restrict Login IP Ranges in the Enhanced Profile User Interface**.
</Note>
...
<table border="1" cellpadding="1" cellspacing="1" data-aura-rendered-by="33:195;a">
  <thead>
    <tr>
      <th colspan="1" rowspan="1"><p> Region </p></th>
      <th colspan="1" rowspan="1"><p> VPC Endpoint IDs </p></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td colspan="1" rowspan="1"><p> us-east-1 (N. Virginia) </p></td>
      <td colspan="1" rowspan="1"><p><span> vpce-3857b651 </span><span></span></p></td>
    </tr>
    <tr>
      <td colspan="1" rowspan="1"><p> us-west-2 (Oregon) </p></td>
      <td colspan="1" rowspan="1"><p><span> vpce-0fe65844cf2a31f0a </span><span></span></p></td>
    </tr>
    <tr>
      <td colspan="1" rowspan="1"><p> ap-southeast-2 (Sydney) </p></td>
      <td colspan="1" rowspan="1"><p><span> vpce-bf4fa1d6 </span><span></span></p></td>
    </tr>
    <tr>
      <td colspan="1" rowspan="1"><p> eu-west-1 (Ireland) </p></td>
      <td colspan="1" rowspan="1"><p><span> vpce-c4788cad </span></p></td>
    </tr>
    <tr>
      <td colspan="1" rowspan="1"><p> eu-west-2 (London) </p></td>
      <td colspan="1" rowspan="1"><p><span> vpce-0982be351f55f5371 </span></p></td>
    </tr>
    <tr>
      <td colspan="1" rowspan="1"><p> ap-northeast-1 (Tokyo) </p></td>
      <td colspan="1" rowspan="1"><p><span> vpce-0055e53d26f729c54 </span></p></td>
    </tr>
    <tr>
      <td colspan="1" rowspan="1"><p> ca-central-1 (Canada Central) </p></td>
      <td colspan="1" rowspan="1"><p><span> vpce-058575bcc0a0034ae </span></p></td>
    </tr>
    <tr>
      <td colspan="1" rowspan="1"><p> ap-south-1 (Mumbai) </p></td>
      <td colspan="1" rowspan="1"><p><span><span> vpce-0c204a0d7fb77896e </span><span></span></span></p></td>
    </tr>
  </tbody>
</table>
