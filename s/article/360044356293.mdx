...
1. Open Workbench 5.
2. Select
   <i className="icon-dots-horizontal" aria-hidden="true" /> **More** (three horizontal dots) > **Export** in the left navigation.
     
   (If the **Export** option does not appear when you select <i className="icon-dots-horizontal" aria-hidden="true" /> **More**, select the lines icon <i className="icon-lines-horizontal" aria-hidden="true" /> to expand it.)
3. Select
...
1. Open Workbench 5.
2. Select
   <i className="icon-dots-horizontal" aria-hidden="true" /> **More** (three horizontal dots) > **Import** in the left navigation.
     
   (If the **Import** option does not appear when you select <i className="icon-dots-horizontal" aria-hidden="true" /> **More**, select the lines icon <i className="icon-lines-horizontal" aria-hidden="true" /> to expand it.)
3. Under
