...
2. (Optional) At the top of the tile editor, rename the tile by selecting <i className="icon-pencil" aria-hidden="true" /> **Edit** and entering the name you want.
...
1. Select the **Rank & Window** tile on the canvas to open the tile editor.
2. (Optional) At the top of the tile editor, reame the tile by selecting <i className="icon-pencil" aria-hidden="true" /> **Edit** and entering the name you want.
3. Select **Add Function**.
