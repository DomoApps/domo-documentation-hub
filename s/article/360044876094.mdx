...
5. Define how to aggregate the new column. Learn about the [aggregation types](#aggregation_types) below.
...
2. (Optional) At the top of the tile editor, rename the tile by selecting <img alt="de_edit.png" src="/images/kb/0EM5w000005vNeQ.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> **Edit** and entering the name you want.
...
9. (Optional) In step 4, select the column to use as a partition, if any. For an explanation of partitioning, see [Understanding Partitions](#h_8a2b5871-00dc-41c7-98c4-649d64420343) at the top of this section.
...
9. (Optional) In step 4, select the column to use as a partition, if any. For an explanation of partitioning, see [Understanding Partitions](#h_8a2b5871-00dc-41c7-98c4-649d64420343) at the top of this page.
...
For an explanation of partitioning, see [Understanding Partitions](#h_8a2b5871-00dc-41c7-98c4-649d64420343) at the top of this section.
...
11. (Optional) In step 4, select the column to use as a partition, if any. For an explanation of partitioning, see [Understanding Partitions](#h_8a2b5871-00dc-41c7-98c4-649d64420343) at the top of this section.
...
9. In step 2, select the column you want your order to be based on.
10. In step 3, select the order in which you want to sort the values in the new column.
11. (Optional) In step 4, select the column to use as a partition, if any. For an explanation of partitioning, see [Understanding Partitions](#h_8a2b5871-00dc-41c7-98c4-649d64420343) at the top of this page.
...
11. (Optional) In Step 4 of the dialog, select the column to use as a partition, if any. (For an explanation of partitioning, see [Understanding Partitions](#h_8a2b5871-00dc-41c7-98c4-649d64420343) at the top of this page.)
...
1. Select the **Rank & Window** tile on the canvas to open the tile editor.
2. (Optional) At the top of the tile editor, reame the tile by selecting <img alt="de_edit.png" src="/images/kb/0EM5w000005vNeQ.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> **Edit** and entering the name you want.
3. Select **Add Function**.
