...
2. (Optional) Rename the tile. In the **Configuration** tab of the tile editor, select <img src="/images/kb/ka05w00000122yV-00N5w00000Ri7BU-0EM5w000005vNgL.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> **Edit**.
