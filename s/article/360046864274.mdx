...
excerpt: "Add a Search & Replace transform in Workbench 4 to swap column values, using the Regular Expression Builder for advanced patterns."
---
...
1. In the
   **Accounts** pane, select the DataSet job in which you want to replace a column value.
2. In the
   **Transforms** grouping in the Buttons toolbar at the top of the Workbench window, click **Add New**.
3. In the
   **Transform Type** menu, select **Search & Replace** then click **Next**.
4. Click
   **Finish**.
     
   A **Search & Replace** item is added under **Transforms** for this DataSet job.
5. Click on the new
   **Search & Replace** item under **Transforms**.
6. In the
...
<iframe allowfullscreen="" frameborder="0" height="315" src="//player.vimeo.com/video/412865212" width="560"></iframe>
