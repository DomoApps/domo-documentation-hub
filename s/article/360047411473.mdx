...
You m ay be wondering which version you're using now. You may also be asked by Domo Support to identify the version in order to provide customized support. There should be a blue icon in the system tray. If you hover over that icon, the version will be displayed.
...
1. In Workbench 4, click
   **Tools > Import**, then select the Workbench 2 or 3 job configuration file (XML) you want then click **Next**.
2. (Conditional) If asked whether you want to overwrite an existing job, select
   **Yes** to overwrite or **No** and enter a new name if you do not want to overwrite the existing file.
3. Click
   **Next**.
4. Click
   **Next** again to confirm.
