...
excerpt: "Export Workbench 4 DataSet Jobs and store the files securely so you can restore them if a job or account is accidentally deleted."
---
...
<iframe allowfullscreen="" frameborder="0" height="315" src="//player.vimeo.com/video/412863229" width="560"></iframe>
...
2. Starting at the bottom and working your way to the top, do the following for each job:
   ...
   1. Right-click the job name and select **Export** **DataSet job**.
      ...
      <Frame><img alt="workbenchtraining_backup1.png" src="/images/kb/ka05w00000123r7-00N5w00000Ri7BU-0EM5w000005vPKV.png"/></Frame>
