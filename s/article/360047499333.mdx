...
excerpt: "Create a Workbench 4 Excel DataSet Job by specifying the Excel sheet location and configuring the cell range for the data to upload."
---
...
<iframe allowfullscreen="" height="315" width="560" src="//player.vimeo.com/video/412866962" scrolling="auto" frameborder="0" spellcheck="false" aria-label="To enrich screen reader interactions, please activate Accessibility in Grammarly extension settings"></iframe>
