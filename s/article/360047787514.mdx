...
excerpt: "Review notable behavior changes, new tiles, and formula system updates in Magic ETL v2 before migrating existing DataFlows."
---
...
* Advanced Options
  ...
  <table class="mt-responsive-table" data-aura-rendered-by="33:208;a"><thead><tr><th class="mt-column-width-15" colspan="1" rowspan="1"><p> Test </p></th><th class="mt-column-width-35" colspan="1" rowspan="1"><p> Evaluated Result </p></th><th class="mt-column-width-20" colspan="1" rowspan="1"><p> Filter Effect </p></th></tr></thead><tbody><tr><td colspan="1" rowspan="1"><p> 4 &lt;&gt; 5 </p></td><td colspan="1" rowspan="1"><p> true </p></td><td colspan="1" rowspan="1"><p> keep </p></td></tr><tr><td colspan="1" rowspan="1"><p> 5 &lt;&gt; 5 </p></td><td colspan="1" rowspan="1"><p> false </p></td><td colspan="1" rowspan="1"><p> drop </p></td></tr><tr><td colspan="1" rowspan="1"><p> null &lt;&gt; 5 </p></td><td colspan="1" rowspan="1"><p> null </p></td><td colspan="1" rowspan="1"><p> drop </p></td></tr><tr><td colspan="1" rowspan="1"><p> null = null </p></td><td colspan="1" rowspan="1"><p> null </p></td><td colspan="1" rowspan="1"><p> drop </p></td></tr><tr><td colspan="1" rowspan="1"><p> null &lt;&gt; null </p></td><td colspan="1" rowspan="1"><p> null </p></td><td colspan="1" rowspan="1"><p> drop </p></td></tr><tr><td colspan="1" rowspan="1"><p> null is null </p></td><td colspan="1" rowspan="1"><p> true </p></td><td colspan="1" rowspan="1"><p> keep </p></td></tr><tr><td colspan="1" rowspan="1"><p> null is not null </p></td><td colspan="1" rowspan="1"><p> false </p></td><td colspan="1" rowspan="1"><p> drop </p></td></tr><tr><td colspan="1" rowspan="1"><p> 5 is not null </p></td><td colspan="1" rowspan="1"><p> true </p></td><td colspan="1" rowspan="1"><p> keep </p></td></tr><tr><td colspan="1" rowspan="1"><p> 5 is null </p></td><td colspan="1" rowspan="1"><p> false </p></td><td colspan="1" rowspan="1"><p> drop </p></td></tr></tbody></table>
  ...
  **Join Data** tile's configuration for describing name conflict resolution. This section can be filled out automatically or manually. In addition to renaming conflicting columns, it is now possible to remove them in the **Join Data** tile's configuration as well.
  ...
  * The new
  **Add Formula** tile—which supports over 200 functions, most of which are unique to the new Magic ETL. When using **Add Formula** for the first time, be sure to expand the formula editor and browse the function list.
  * The
  **Input DataSet** tile—which now supports changing the type of incoming columns, as well as configuring how errors and nulls should be handled. If you want to interpret all nulls in a Text column as the Empty String instead, you can now do so.
  * The new
  **Dynamic Unpivot** tile—which makes more sense in some scenarios than the older Unpivot (**Collapse Columns**) tile. If you want to pivot all columns except a few, rather than pivoting a few columns and leaving most alone, consider using this new tile.
...
## Editor Known Issues and Quick Fixes

Some Magic ETL editor issues have been reported after platform updates. Most are transient session or display issues that do not affect your saved DataFlow or its output data. If you encounter one of the following, try the quick fix before contacting your Domo account team.

| Symptom                                                                                                          | Likely Cause                                                                       | Quick Fix                                                                                                                                                    |
| ---------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| "Unable to save your changes" appears when you select **Save** or **Save and Run**.                              | The same DataFlow is open in another browser tab, or an input tile is out of sync. | Close any other tab that has this DataFlow open, then save again. If the error continues, remove and re-add the affected **Input DataSet** tiles, then save. |
| The **Validate** button on a **Group By** tile reports an error after a release, but the calculation is correct. | A display-only regression in the validation check.                                 | The calculation still resolves and the DataFlow still runs. You can save and run as normal.                                                                  |
| You can no longer cut text (Ctrl+X / Cmd+X) from a field or connection string in the editor.                     | An editor session issue.                                                           | Close and reopen the DataFlow to restore the expected cut behavior.                                                                                          |
| Pop-up or dialog text renders in dark, hard-to-read text.                                                        | A theme rendering issue in some browser and theme combinations.                    | Refresh the page. If the text is still unreadable, switch color themes or contact your Domo account team.                                                    |
| The formula editor scrolls on its own, or the cursor jumps while you type.                                       | A formula-editor display issue.                                                    | Refresh the page and reopen the formula editor. If it continues, contact your Domo account team.                                                             |
