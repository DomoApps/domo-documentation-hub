---
title: "2020 Release 1 | March"
excerpt: "March 2020 release notes covering updated left navigation, third-level Pages, favorite Pages, Story Embed, and programmatic filter embed."
---
...
For more information, see [Sharing Cards and Stories Outside of Domo Using Domo Embed](/s/article/360043437993).
...
For more information, see Using Programmatic Filters with Domo Embed (BETA)").
...
* ****Impact card****
  . A new card in the ********Overview******** tab shows you the number of DataSets, DataFlows, Cards, and Alerts directly and indirectly impacted by changes to that DataSet. The card displays the direct impact for each, along with the total number of impacts.
    
  <Frame><img alt="data_impact_analysis_rn.png" src="/images/kb/ka05w00000123vE-00N5w00000Ri7BU-0EM5w000005vPWp.png"/></Frame>
* ****Lineage view****
  . This view shows you the upstream and downstream impact of changes made to the DataSet. You can also see the lineage for a DataSet simply by clicking on the ********Lineage******** tab.
...
* Apply predefined or custom date formatting to specific columns. The
  **Date Shorthand** and **Full Date** predefined options both take your locale into consideration when used; for example, if your locale is Japan, a Japanese date format will be applied automatically if you select either of these options.
...
For more information, see [Setting Up Publication Groups](https://domo-support.domo.com/s/article/360043438993?language=en_US "Setting Up Publication Groups").
...
For more information, see [Analyzer Layout](https://domo-support.domo.com/s/article/360042924034?language=en_US "Analyzer Layout").
...
Make timely and more relevant data-driven decisions by getting large datasets into Domo faster. Domo's suite of High-Bandwidth Connectors allow you to integrate data 3-6 times faster than the current connectors. These connectors are available for the following systems:
...
You can view the latest release notes information in the Help Center, which you can access from Domo by clicking <img src="/images/kb/ka0Vq000000GneH-00N5w00000Ri7BU-0EM5w000005vOjG.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> in the top navigation bar.
