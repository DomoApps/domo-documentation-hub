...
1. Hover over the app card until
   <i className="icon-wrench-fill sm" aria-hidden="true" /> **Card options** displays.
2. Select
   <i className="icon-wrench-fill sm" aria-hidden="true" /> **Card options** > **Edit Card**. The app editor opens.
3. Scroll down to see a list of the DataSets powering the app.

   <Frame>
     <img alt="app datasets.jpg" src="/images/kb/ka05w0000012BmO-00N5w00000Ri7BU-0EM5w000006uSGi.jpg" />
   </Frame>
...
1. Hover over the app card until
   <i className="icon-wrench-fill sm" aria-hidden="true" /> **Card options** displays.
2. Select
   <i className="icon-wrench-fill sm" aria-hidden="true" /> **Card options** > **Details**. The Details view for the app displays.
3. Right-click on the page and select
   **Inspect**. The Inspect tool displays.

   <Frame>
     <img alt="Screenshot 2023-04-12 at 6.04.27 PM.png" src="/images/kb/ka05w0000012BmO-00N5w00000Ri7BU-0EM5w000006uSGn.jpg" />
   </Frame>
4. Navigate to the
   **Network** tab of the tool.

   <Frame>
     <img alt="select network.jpg" src="/images/kb/ka05w0000012BmO-00N5w00000Ri7BU-0EM5w000006uSGx.jpg" />
   </Frame>
5. With the
