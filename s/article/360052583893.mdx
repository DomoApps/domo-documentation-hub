...
1. Hover over the app card until
   <i className="icon-wrench-fill" aria-hidden="true" /> <i className="icon-chevron-down" aria-hidden="true" /> **Card options** displays.
2. Select
   <i className="icon-wrench-fill" aria-hidden="true" /> <i className="icon-chevron-down" aria-hidden="true" /> **Card options** > **Edit Card**. The app editor opens.
...
1. Hover over the app card until
   <i className="icon-wrench-fill" aria-hidden="true" /> <i className="icon-chevron-down" aria-hidden="true" /> **Card options** displays.
2. Select
   <i className="icon-wrench-fill" aria-hidden="true" /> <i className="icon-chevron-down" aria-hidden="true" /> **Card options** > **Details**. The Details view for the app displays.
