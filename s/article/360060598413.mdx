...
excerpt: "Overview of machine learning task types including regression, classification, clustering, and forecasting along with common algorithms and applications."
---

## Intro

This article covers common machine learning task types—including regression and classification—along with related algorithms, model evaluation metrics, and the AutoML model types and hyperparameters that Domo supports.
