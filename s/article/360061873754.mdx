...
<Columns>
  <Frame><img alt="Basic_Scheduling.png" src="/images/kb/ka05w00000129sq-00N5w00000Ri7BU-0EM5w000005wKmU.png" style={{width: 499, height: 223}}/></Frame>
...
<Frame><img alt="Buzz_Layout.png" src="/images/kb/ka05w00000129sq-00N5w00000Ri7BU-0EM5w000005wKmW.png" style={{width: 362, height: 376}}/></Frame>
## Goals
...
Magic ETL v2 (Beta) has many backend and tile improvements as well as new tiles. When you open the edit view of a Magic ETL DataFlow, there is now a toggle switch to enable Magic ETL v
2. It is important to note that some of the tiles have changed their functionality. For more information, see [Magic ETL v2 DataFlow Optimizations](/s/article/360051062653).
...
<Warning>
  ...
  **MUST**
  ...
  [Upgrading to Magic ETL v2](/s/article/360047787514)
