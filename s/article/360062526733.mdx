...
**Accounts** icon in the left-hand pane.
...
**Login** to finish creating the Account.
...
1. In the Data Center, click on the
**DataSets** icon in the left-hand pane.
...
4. Under
**Settings**, look for the **Credentials**. You will now be able to select the Salesforce Pardot OAuth Account that you have previously created.
