...
7. When finished with the Card, select
   **Save and Close** from the drop-down menu.
...
<AccordionGroup>
<Accordion title="How do Custom Roles work with DataSet Views in Analyzer?">
...
<Accordion title="How does PDP work with DataSet Views in Analyzer?">
...
<Accordion title="Are creation and edits to DataSet Views in Analyzer tracked in the Audit Log?">
