---
title: "Microsoft Exchange Mailbox Only Connector"
---
...
For more information, see [https://learn.microsoft.com/en-us/entra/identity-platform/quickstart-register-app](https://learn.microsoft.com/en-us/entra/identity-platform/quickstart-register-app "https://learn.microsoft.com/en-us/entra/identity-platform/quickstart-register-app").
...
<Note>
    ...
    **Note:** The authentication response is sent to this URI after successfully authenticating the user. Providing the
    URI at this stage is optional and it can be changed later, but a value is required for most of the authentication
    scenarios.
...
<img alt="Register_an_application.png" src="/images/kb/ka0Vq0000000XVR-00N5w00000Ri7BU-0EM5w000005vNxU.png" />
...
<img alt="Permissions.png" src="/images/kb/ka0Vq0000000XVR-00N5w00000Ri7BU-0EM5w000005vNxY.png" />
...
<span>
                    ...
                    {" "}
                    Returns message details like recipients, body, subject, size, importance, sender's name, received time,
                    sent time, etc.{" "}
...
<td colspan="1" rowspan="1">
                ...
                {" "}
                Returns results based on search criteria. Use the Search query parameter to restrict the results of a request
                to match a search criterion.{" "}
...
<b>
 ...
 , you are prompted to enter a subject line
          and sender name for the search. If you select
