...
There are two parts to using Aggregated Filters as a Quick filter. First is creating the Aggregated Quick Filter, and second is using the Aggregated Quick Filter.
...
2. Click
   <img src="/images/kb/ka05w00000123l5-00N5w00000Ri7BU-0EM5w000005vP07.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/>. (Some system Pages, such as the Shared Page, do not include this option.)
