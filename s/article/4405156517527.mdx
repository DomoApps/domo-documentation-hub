...
2. (Optional) Rename the tile by clicking <i className="icon-pencil sm" aria-hidden="true" />, then entering the name you want.
3. Select the columns you want to use in the subsequent Python or R Scripting tile.
4. (Optional) To verify all desired columns have been selected, hide all non-selected columns in the list by clicking the eye icon <i className="icon-eye sm" aria-hidden="true" />.
