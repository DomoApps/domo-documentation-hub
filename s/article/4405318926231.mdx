...
excerpt: "Use the Excel to Domo Matrix to translate familiar Excel functions to their Domo equivalents and accelerate your transition from Excel."
---

## Intro

This article explains how to use the Excel to Domo Matrix (EDM) to translate frequently used Excel functions to their Domo equivalents and accelerate your transition from Excel.
