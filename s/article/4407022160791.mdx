...
For information about running the Workbench service, see [Starting, Stopping, and Restarting the Workbench 5.1 Service](/s/article/4407023720343).
...
<Note>**Note:** Workbench must be run as an Administrator in order to work.</Note>
