...
1. Click the <InlineImage src="/images/domocons/database.svg" /> icon in the left-hand icon bar.
...
When you first connect to Domo via Workbench, Workbench leverages your Windows system proxy settings. You can open your proxy settings for editing by clicking dots icon <i className="icon-dots-horizontal" aria-hidden="true" /> and selecting **Proxy**.
...
Yes. Workbench 5.1 allows the mass import/export of job files. Click the dots icon <i className="icon-dots-horizontal" aria-hidden="true" /> and select **Export**. You can then choose a save folder and select all of the jobs you want to export.
