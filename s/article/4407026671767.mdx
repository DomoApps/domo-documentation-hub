...
1. Click the <img src="/images/kb/ka05w00000123sE-00N5w00000Ri7BU-0EM5w000005vPOU.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> icon in the left-hand icon bar.
...
When you first connect to Domo via Workbench, Workbench leverages your Windows system proxy settings. You can open your proxy settings for editing by clicking <img src="/images/kb/ka05w00000123t2-00N5w00000Ri7BU-0EM5w000005vPP4.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> and selecting **Proxy**.
...
Yes. Workbench 5.1 allows the mass import/export of job files. Click <img src="/images/kb/ka05w00000123t2-00N5w00000Ri7BU-0EM5w000005vPP4.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> and select **Export**. You can then choose a save folder and select all of the jobs you want to export.
