...
excerpt: "Training topics for Workbench 5.1 covering version migration, installing updates, and managing automatic updates."
---

## Intro

This article covers Workbench 5.1 training topics, including migrating to a newer version and installing updates, managing the job queue, and using impersonation.
...
1. Under
   **Settings**,
   ...
   turn on **Run job process as** **Below Normal priority**.
...
2. Click the
   <img src="/images/kb/ka05w00000123tG-00N5w00000Ri7BU-0EM5w000005vPPb.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> button at the top.
...
2. Click the
   <img src="/images/kb/ka05w00000123tG-00N5w00000Ri7BU-0EM5w000005vPPk.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> button at the top.
