---
title: "DataSet Backup"
---

## Intro

The DataSet Backup tool allows you to back up Domo DataSets to your Amazon S3.
...
1. Navigate to the Account section in your Data Center.
   * https://example.domo.com/datacenter/accounts
2. Click the
   **Add New** button in the top right-hand corner.
   * Select
     **Account**.
3. Search for
   **Amazon S3**.
...
1. Navigate to the
   **Governance Toolkit** and select **PDP Automation**.
