...
excerpt: "Use the Tag Management tool in the Governance Toolkit to manage tags across Domo assets with custom pipeline process grants."
---

## Intro

This article explains how to use the Tag Management tool in the Governance Toolkit to apply tags across your Domo DataSets and DataFlows, including creating Tag Settings jobs and Configuration DataSet jobs.
