...
4. **Pfilter URL parameters**
   ...
   Documentation: [Pfilters — URL Parameters in Embedded Content <i className="icon-arrow-square-out sm" aria-hidden="true" />](https://developer.domo.com/portal/buk5zwk1pvjwh-url-parameters-in-embedded-content#pfilters)
