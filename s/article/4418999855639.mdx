...
4. **Pfilter URL parameters**
   ...
   Documentation: [Pfilters — URL Parameters in Embedded Content](https://developer.domo.com/portal/buk5zwk1pvjwh-url-parameters-in-embedded-content#pfilters) <img src="/images/kb/ka0Vq00000001FR-00N5w00000Ri7BU-0EMVq0000000XDh.jpg" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/>
