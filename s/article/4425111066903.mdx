...
<Warning>
  **Important:**
  ...
  [Upgrading to the New Magic ETL](/s/article/360047787514)
  .
...
You are also able to set the time that it runs in your time zone, instead of the default of UTC. For more information, see Scheduling DataFlows.
