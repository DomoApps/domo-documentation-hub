...
2. From the
**Features** section, select **Goals**.

3. In
**General** tab, select an option from the **Goals Nomenclature** menu.
...
<Frame><img alt="Screen_Shot_2022-08-16_at_11.50.28_AM.png" src="/images/kb/ka05w00000123aY-00N5w00000Ri7BU-0EM5w000005vObe.png"/></Frame>
4. Select
**Save**.
...
<Warning>
  **Important:**
  You will NOT be able to create any goals until time periods are created.
...
3. In the
**General** tab, go to the **Select a period to edit** menu.

4. From the menu, choose a period to edit. Give the time period a
**Name**, and select T**ime period start and end dates**.

5. Select
**Save**.

6. (Optional)
Repeat this process for multiple time periods.
...
3. In the
**General** tab, locate the **Weekly Goals email** toggle.
...
<Frame><img alt="Screen_Shot_2022-08-16_at_12.08.19_PM.png" src="/images/kb/ka05w00000123aY-00N5w00000Ri7BU-0EM5w000005vOba.png"/></Frame>
...
3. In the
**Objectives and Key Results** tab, locate the **Automatic Objective Status** toggle.
...
4. Specify
**What person or group you want to assign a delegate to** and **Select a delegate.**

5. Select
**Add**.

6. (Optional) Search for existing delegates in the
**Search delegates** field.

People/groups and their delegates appear in a list in the main **Delegates** tab.

<Frame><img alt="Screen_Shot_2022-08-16_at_12.56.51_PM.png" src="/images/kb/ka05w00000123aY-00N5w00000Ri7BU-0EM5w000005vObT.png"/></Frame>
...
6. Select
**Manage.** A list of tags in the chosen category displays. In the **Select tags** menu, add new tags to the category. To create a new tag, begin typing a new title and select the **+** *Your Tag* button.

7. (Optional) To remove tags from the category, select
<img src="/images/kb/ka05w00000123aY-00N5w00000Ri7BU-0EM5w000005vObX.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> delete next to the tag.

8. (Optional) To remove a tag category, select the box next to the category's name. Select
<img src="/images/kb/ka05w00000123aY-00N5w00000Ri7BU-0EM5w000005vObZ.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> delete.
...
**New name** field. (Optional) select a tag category and click **Create.**
...
**Uncategorized**. Select <img src="/images/kb/ka05w00000123aY-00N5w00000Ri7BU-0EM5w000005vObS.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> edit. From the menu, select an existing category and click **Save**.
...
To rename a tag, select <img src="/images/kb/ka05w00000123aY-00N5w00000Ri7BU-0EM5w000005vObS.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> edit next to its name.

#### Merging a Tag

1. To merge a tag, select the boxes next to multiple tag names. Select
<img src="/images/kb/ka05w00000123aY-00N5w00000Ri7BU-0EM5w000005vObW.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> merge.
...
<Frame><img alt="Screen_Shot_2022-08-16_at_3.04.03_PM.png" src="/images/kb/ka05w00000123aY-00N5w00000Ri7BU-0EM5w000005vObV.png"/></Frame>
