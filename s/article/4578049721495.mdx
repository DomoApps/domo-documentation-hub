...
**Delete** <img src="/images/kb/ka05w00000123aH-00N5w00000Ri7BU-0EM5w000005vOZe.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> next to the tag.
...
To add a file or card, select **Add Attachment** <img src="/images/kb/ka05w00000123aH-00N5w00000Ri7BU-0EM5w000005vOZx.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> in the message field.
...
**+ Parent Goal** or **+ Link Child Goal.**
    ...
    * If you chose
      **+ Link Child Goal**, you can search for an existing goal or create a new one. The options for creating a new goal are the same as those described in [Getting Started With Goals](/s/article/4578278680855) and will become a child goal automatically.

#### Tree View

Tree view displays an entire hierarchy of a goal with its child goals.

Select **View Tree** in the **Goal Options** <img src="/images/kb/ka05w00000123aH-00N5w00000Ri7BU-0EM5w000005vOZr.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> menu.

<Frame><img alt="2022-09-12_19-38-09.png" src="/images/kb/ka05w00000123aH-00N5w00000Ri7BU-0EM5w000005vOZp.png"/></Frame>
Or, select <img src="/images/kb/ka05w00000123aH-00N5w00000Ri7BU-0EM5w000005vOZn.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> from the **Personal**, **Teams**, or **Company** tabs.
...
Select **View Lineage** in the **Goal Options** <img src="/images/kb/ka05w00000123aH-00N5w00000Ri7BU-0EM5w000005vOZr.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> menu in the **Goal Details** page.
