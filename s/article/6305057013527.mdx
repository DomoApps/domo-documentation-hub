...
excerpt: "Use the User Management toolkit to automate creating, updating, and assigning attributes to users in your Domo instance via a configuration DataSet."
---
...
2. Go to
   **User Management**.
   ...
   <Frame><img alt="" src="/images/kb/ka0Vq000000Edkf-00N5w00000Ri7BU-0EMVq000007ZFZd.jpg"/></Frame>
   <Note>
     **Note:**
...
You must create a configuration DataSet for User Management. It should match the formatting of the **Bulk Import** feature found in the Governance Admin Settings (**Admin** > **Governance** > **People**). An example import file is available there. Learn more about [bulk importing](/s/article/360042934274#addedit-users-in-bulk).
...
<table border="1" cellpadding="1" cellspacing="1" data-aura-rendered-by="33:209;a"><thead><tr><td colspan="1" rowspan="1"><b> Column Header </b></td><td colspan="1" rowspan="1"><b> Type </b></td><td colspan="1" rowspan="1"><b> Format </b></td></tr></thead><tbody><tr><td colspan="1" rowspan="1"> displayName </td><td colspan="1" rowspan="1"> String </td><td colspan="1" rowspan="1"> John Smith </td></tr><tr><td colspan="1" rowspan="1"><p> roleId </p><p> As with all other fields listed in this table, roleId is required. </p></td><td colspan="1" rowspan="1"> Number </td><td colspan="1" rowspan="1"><p> Valid roleId values include: </p><ul><li> 1 (Admin) </li><li> 2 (Privileged) </li><li> 3 (Editor) </li><li> 4 (Participant) </li><li> 5 (Social) </li></ul><div class="mdx-embed"><Note><p><b> Note: </b> If the Custom Role feature is enabled for your instance, you can also enter a user's custom Role ID. <p></p><p> Find the Role ID by going to <b> Admin </b> &gt; <b> Governance </b> &gt; <b> Roles </b>. Select the role from the list and go to the <b> Details </b> tab. Locate the <b> Role ID. </b></p><p></p><p><img alt="non cloud admin.jpg" src="/images/kb/ka0Vq000000EdeD-00N5w00000Ri7BU-0EMVq000001REMT.jpg" style={{width: 325, height: 402}}/><br/></p></p></Note></div></td></tr><tr><td colspan="1" rowspan="1"> title </td><td colspan="1" rowspan="1"> String </td><td colspan="1" rowspan="1"> Software Engineer </td></tr><tr><td colspan="1" rowspan="1"> department </td><td colspan="1" rowspan="1"> String </td><td colspan="1" rowspan="1"> Development </td></tr><tr><td colspan="1" rowspan="1"> email </td><td colspan="1" rowspan="1"> Email </td><td colspan="1" rowspan="1"> johnsmith @ example. com </td></tr><tr><td colspan="1" rowspan="1"> alternateEmail </td><td colspan="1" rowspan="1"> Email </td><td colspan="1" rowspan="1"> john_smith @ example. com </td></tr><tr><td colspan="1" rowspan="1"> phoneNumber </td><td colspan="1" rowspan="1"> International phone number </td><td colspan="1" rowspan="1"> Example: <em> (800) 899-1000 </em></td></tr><tr><td colspan="1" rowspan="1"> deskPhoneNumber </td><td colspan="1" rowspan="1"> International phone number </td><td colspan="1" rowspan="1"> Example: <em> (800) 899-1000 </em></td></tr><tr><td colspan="1" rowspan="1"> employeeNumber </td><td colspan="1" rowspan="1"> Number — Long or integer </td><td colspan="1" rowspan="1"> 0074 </td></tr><tr><td colspan="1" rowspan="1"> location </td><td colspan="1" rowspan="1"> String </td><td colspan="1" rowspan="1"><p> Utah </p></td></tr><tr><td colspan="1" rowspan="1"> timeZone </td><td colspan="1" rowspan="1"> String </td><td colspan="1" rowspan="1"><p> Example: America/Denver </p><p> See this Wikipedia article for a list of the <a href="https://en.wikipedia.org/wiki/List_of_tz_database_time_zones" target="_blank"> tz database time zones </a><img src="/images/kb/ka0Vq000000Edkf-00N5w00000Ri7BU-0EMVq000001Cz3x.jpg" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/>. </p></td></tr><tr><td colspan="1" rowspan="1"> locale </td><td colspan="1" rowspan="1"> Locale language tag </td><td colspan="1" rowspan="1"><p> Valid locale values include: </p><p> de-DE, de-AT, de-CH, en-AU, en-CA, en-150, en-HK, en-IE, en-IL, en-MO, en-NZ, en-SG, en-GB, en-US, en-001, es-ES, es-US, es-419, es-MX, fr-BE, fr-CA, fr-FR, fr-CH, nl-BE, nl-NL, pt-BR, pt-PT, ja-JP, zh-CN, zh-Hans-HK, zh-Hans-MO, zh-Hans-SG <a id="create_a_job" target="_blank"></a></p></td></tr><tr><td colspan="1" rowspan="1"> employeeId </td><td colspan="1" rowspan="1"> String </td><td colspan="1" rowspan="1"><p> UT000034065 </p></td></tr></tbody></table>

## Create a Job

Follow these steps to create a job:

1. [Access](#access-user-management)
   User Management.
2. Select
   **+ New Job**.
3. Provide the following information:
   ...
   **Note:** The fields marked with an asterisk (**\***) are required.
   ...
   + Configuration DataSet
     **\*** Learn how to create your configuration DataSet [above](#create-the-configuration-dataset).
...
<Frame><img alt="" src="/images/kb/ka0Vq000000Edkf-00N5w00000Ri7BU-0EMVq000007ONsH.jpg"/></Frame>
...
2. Hover over the job you want to run and select
   **Options** > **Run Job**.
   ...
   <Frame><img alt="" src="/images/kb/ka0Vq000000Edkf-00N5w00000Ri7BU-0EMVq000007P16Z.jpg"/></Frame>
## Manage Attributes With the Configuration DataSet

You can use the User Management [configuration DataSet](#create-the-configuration-dataset) to help create and manage system and custom attributes in your instance in bulk.
...
<Note>
  **What are attributes?**
  ...
  [above](#create-the-configuration-dataset)
...
<Frame><img alt="" src="/images/kb/ka0Vq000000Edkf-00N5w00000Ri7BU-0EMVq000007PBgz.jpg"/></Frame>
...
1. Add a \<
   *custom attribute* > column for each custom attribute to the configuration DataSet, where the column name is the custom attribute's Key.
   ...
   <Frame><img alt="" src="/images/kb/ka0Vq000000Edkf-00N5w00000Ri7BU-0EMVq000007ZlOD.jpg"/></Frame>
...
4. [Access](#access-user-management)
...
6. Choose your updated DataSet in the
   **Configuration Dataset** dropdown.
   ...
   <Frame><img alt="" src="/images/kb/ka0Vq000000Edkf-00N5w00000Ri7BU-0EMVq000007OIqz.jpg"/></Frame>
...
<Frame><img alt="Screenshot 2024-06-06 at 10.03.13 AM.png" src="/images/kb/ka0Vq000000Edkf-00N5w00000Ri7BU-0EMVq000001EzZJ.jpg"/></Frame>
## Remote Instance Configuration

With remote instance configuration, you can be in one Domo instance and manage individuals in other instances you have access to. You can manage individuals remotely by setting up the [configuration DataSet](#create-the-configuration-dataset). Configure the [Domo Access Token account](#configure-a-domo-access-token-account) with either a [Domo Access token](#generate-an-access-token) or a username and password for the remote instance.
...
1. While creating or editing a job, under
   **Configuration**, select a configuration DataSet. This DataSet should be populated with valid values for the remote instance according to User Management guidelines given [above](#create-the-configuration-dataset).
2. Under
   **Where would you like to run this job?** select **Remote Instance**.
     
   <Frame><img alt="" src="/images/kb/ka0Vq000000Edkf-00N5w00000Ri7BU-0EMVq000007PAhh.jpg"/></Frame>
3. In the
...
4. Use the
   **Select the account for your instance:** dropdown to select a valid Domo Access Account. Learn how to configure a Domo Access Token Account [below](#configure-a-domo-access-token-account).
...
2. Select
   **Add New** > **Account** and use the dropdown to choose a Domo Access Token account.
   ...
   <Frame><img alt="" src="/images/kb/ka0Vq000000Edkf-00N5w00000Ri7BU-0EMVq000007P9X7.jpg"/></Frame>
...
2. On the
   **Access tokens** page, select **+ Generate access token**.
   ...
   <Frame><img alt="" src="/images/kb/ka0Vq000000Edkf-00N5w00000Ri7BU-0EMVq000007PA09.jpg"/></Frame>
3. Enter a description in the
   **Access token description** field.
     
   <Frame><img alt="" src="/images/kb/ka0Vq000000Edkf-00N5w00000Ri7BU-0EMVq000007PA9p.jpg"/></Frame>
...
<AccordionGroup>
  <Accordion title="How Do I Create Users Without Sending Invite Emails?">
    When you create users with a User Management job, leave the **Send invite** box unchecked in the job configuration. New users are created without receiving an email invitation. (Checking **Send invite** sends an email to all newly created users.)

    You can also create a single user without an invite from the [Domo CLI tool](/s/article/360043437733#create-a-user): run the `create-user` command with `-i false` instead of `-i true`. The `-i` flag controls whether an email invitation is sent.
  </Accordion>

  <Accordion title="Can I Update Passwords or Credentials in Bulk?">
    No. The User Management configuration DataSet manages user records, roles, and attributes; it has no password or credential field, so passwords are not set or changed through this tool. Password resets are handled per user by an admin with the **Manage All Users** grant.
  </Accordion>

  <Accordion title="How Do I Suppress Product Release Notifications for Embedded Users?">
    Embedded users receive Domo-generated product release notifications the same way other users do. The supported way to suppress these notifications for embedded users is not currently documented.

    {/* [pm-input] Ryan Despain — confirm whether product release notifications can be suppressed for embedded users, and the supported setting or method for doing so. Synthesized from community forum reports; needs confirmation. */}
  </Accordion>

  <Accordion title="Can I Temporarily Deactivate a User Instead of Deleting Them?">
    Domo does not provide a single suspend-and-reactivate toggle for user accounts. To restrict a user's access without losing their account, change their role to **Social** (roleId 5) — the most limited role — which keeps the account and its history intact.

    If the person owns content, transfer their owned objects to another user or a temporary holding account before you reduce their access or remove them. When you delete a user who owns DataSets or DataFlows, Domo prompts you to reassign those items; however, connected accounts do not transfer automatically and must be reassigned manually. For the full content-transfer process, see [Remove Users from Domo](/s/article/360042934334).
