...
<Frame><img alt="Screen_Shot_2022-09-28_at_3.28.54_PM.png" src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXl5.png" style={{width: 898, height: 492}}/></Frame>
...
<Frame><img alt="accessing_BME.png" src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXlH.png" style={{width: 897, height: 486}}/></Frame>
Inside the Beast Mode Editor, you can view all Variables in your Domo instance by selecting the **Variables** tab.

<Frame><img alt="variables_tab.png" src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXks.png" style={{width: 462, height: 298}}/></Frame>
...
<Frame><img alt="Screen_Shot_2022-10-07_at_12.19.50_AM.png" src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXlF.png" style={{width: 199, height: 941}}/></Frame>
...
4. Below the list of Variables in your instance, select **Add Variable**.   
    ...
    <Frame><img alt="add_variable.png" src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXky.png" style={{width: 179, height: 195}}/></Frame>
5. Under
...
6. Under **Variable Value**, select a data type and enter a **Default** **value**. This default value is the value of the Variable every time it is used in a Beast Mode. If the default value is changed and saved here in the editor, the change is reflected in every Beast Mode in your instance where the Variable is being used.   
    ...
    <Frame><img alt="variable_value.png" src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXkt.png" style={{width: 801, height: 372}}/></Frame>
7. Select **Create Variable**.   
      
    <Frame><img alt="Screen_Shot_2022-10-07_at_12.46.35_AM.png" src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXku.png" style={{width: 366, height: 250}}/></Frame>
...
10. Locate the basic or global Variable that you created, organized by data type and alphabetically by name.    
     ...
     <Frame><img alt="edit_delete_variable.png" src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXl4.png" style={{width: 264, height: 58}}/></Frame>
...
5. (Optional) Repeat steps 3–4 to add as many Variables as you would like to your Beast Mode.   
    ...
    <Frame><img alt="variables_in_a_beast_mode.png" src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXlJ.png" style={{width: 896, height: 126}}/></Frame>
...
<Frame><img alt="controls_in_analyzer.png" src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXlA.png" style={{width: 801, height: 499}}/></Frame>
...
2. Under **Default Control**, select **+ Create** **Control**.   
    ...
    <Frame><img alt="Screen_Shot_2022-08-31_at_5.36.07_PM.png" src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXlI.png" style={{width: 701, height: 384}}/></Frame>
3. Choose the kind of control. Some options may be unavailable based on the Variable's data type.   
      
    <Frame><img alt="Screen_Shot_2022-10-07_at_1.10.54_AM.png" src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXkw.png" style={{width: 900, height: 207}}/></Frame>
4. Configure the control based on the kind of control and the available values. You can preview how the control displays in Analyzer.   
    ...
    <Frame><img alt="Screen_Shot_2022-10-07_at_1.13.02_AM.png" src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXlG.png" style={{width: 898, height: 269}}/></Frame>
5. (Optional) If you want to add the control to Analyzer so that you can try out different scenarios with the Variable, check the box for **Add Control to Analyzer**.   
    ...
    <Frame><img alt="add_control_to_analyzer.png" src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXl6.png" style={{width: 247, height: 59}}/></Frame>
...
<Frame><img alt="clickanddrag.png" src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXl2.png" style={{width: 499, height: 491}}/></Frame>
2. Select
**Add**.
  
A list of available Variables displays.

<Frame><img alt="Screen_Shot_2022-10-18_at_8.02.27_AM.png" src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXlE.png" style={{width: 277, height: 210}}/></Frame>
3. Select the Variable you want to add to the dashboard from the list.

The Dashboard Variable Control displays.

<Frame><img alt="advertising___off.png" src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXkr.png" style={{width: 570, height: 265}}/></Frame>
<Note>
  **Note:**
...
<Frame><img alt="Screen_Shot_2022-10-06_at_11.50.02_PM.png" src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXlC.png" style={{width: 462, height: 150}}/></Frame>
...
<Frame><img alt="edit_variables_grant.png" src="/images/kb/ka0Vq0000008ZWr-00N5w00000Ri7BU-0EM5w000005vXlB.png" style={{width: 880, height: 333}}/></Frame>
