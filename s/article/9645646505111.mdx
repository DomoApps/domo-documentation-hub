...
<Note>**Note:** Depending on the feature, you may be required to complete training before you can use this feature.</Note>
...
You can view the latest release notes information in the Help Center, which you can access from Domo by clicking <img alt="help_center_icon.png" src="/images/kb/0EM5w000005vXng.png" style={{width: 20, height: 20, display: 'inline', verticalAlign: 'start', margin: '0'}}/> in the top navigation bar.
...
For more information about getting help, see [Getting Help](/s/article/360042922874).