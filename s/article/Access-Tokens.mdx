...
5. In the **Expire after** list, select the lifespan of the token.
6. Select **Generate**.
...
After navigating to the **Manage access tokens** page, your access tokens are listed in the table. The table displays each token's description, creation date, expiration date, and status.
