...
- **Data freshness checks** — Domo polls your source cloud warehouse on a schedule to detect when the underlying data has changed. When an update is detected, connected cards, alerts, and DataFlows reflect the new data on their next load.
