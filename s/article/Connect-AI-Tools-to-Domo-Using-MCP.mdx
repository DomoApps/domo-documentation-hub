...
<Note>**Note:** This feature is in beta. Contact your Domo account team to join.</Note>
...
<Frame>![](/images/kb/DOMO-MCP-Server-Screenshot-1.png)</Frame>
...
- Your user has the following grants enabled: **Use AI Chat** & **Use AI Services**
...
<Accordion title='Which AI tools are compatible with the Domo MCP Server?'>
	The Domo MCP Server works with any MCP-compatible AI client, including Claude Desktop, Claude Code, VS Code, Cursor,
	and ChatGPT.
</Accordion>

<Accordion title="What can I do after I'm connected?">
	After you're connected, you can query your Domo DataSets, query documents stored in Domo, and search across your Domo
	instance. Card and page summarization are coming soon.
</Accordion>
