...
<Tip>**Tip:** For large Data Models with many tables, you can pan and navigate around the canvas freely. Drag DataSet cards to rearrange them and keep the layout easy to read. Use the zoom out, zoom in, center canvas, and mini-map controls to navigate through your model.</Tip>
