...
This article explains how to use the Databricks using OAuth M2M Authentication connector to configure OAuth 2.0 client credentials authentication, connect Domo to your Databricks workspace, and import data into Domo.
