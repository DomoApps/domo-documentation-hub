---
title: Domo AI FAQ
excerpt: "Frequently asked questions about how Domo's AI engine processes customer data, handles third-party providers, and manages security and privacy."
---
...
<AccordionGroup>
  ...
  <Accordion title="Does the solution rely on third-party AI providers for model inference or data processing?">
    When using DomoGPT (based on Anthropic Claude models in Amazon Bedrock), data sent to the model stays within Domo's hosting environment in AWS. For many products and specific "Covered Models," Anthropic retains conversation content (prompts and outputs) for 30 days by default to monitor for abuse, safety issues, and platform reliability. Data sent to the model may not be used to further train models.
  </Accordion>
  ...
  <Accordion title="Are prompts, inputs, embeddings, or outputs stored by the solution or any third-party provider?">
    Domo stores agent requests and responses to provide session and conversation history. Third-party providers may also retain this data for a limited period: for many products and specific "Covered Models," Anthropic retains conversation content (prompts and outputs) for 30 days by default to monitor for abuse, safety issues, and platform reliability.
  </Accordion>
