---
title: "Manually Connect to the Domo Essentials MCP Server"
excerpt: "How to manually connect to the Domo Essentials MCP Server."
tag: "Beta"
---
...
<Frame>![Access Tokens management page in Domo Admin settings](/images/kb/DOMO-MCP-Server-Screenshot-2.png)</Frame>
...
<Frame>![Claude Desktop application download page](/images/kb/DOMO-MCP-Server-Screenshot-3.png)</Frame>

### Step 4: Edit the Claude Desktop configuration

In Claude Desktop, go to **Settings** > **Developer** and select **Edit Config**.

<Frame>![Claude Desktop Settings Developer tab showing Edit Config option](/images/kb/DOMO-MCP-Server-Screenshot-4.png)</Frame>
...
<Frame>![Claude Desktop configuration file open in a text editor](/images/kb/DOMO-MCP-Server-Screenshot-5.png)</Frame>
...
<Frame>![Claude Desktop restart prompt](/images/kb/DOMO-MCP-Server-Screenshot-6.png)</Frame>
...
<Frame>![Claude Desktop Customize panel showing the connected Domo MCP server](/images/kb/DOMO-MCP-Server-Screenshot-7.png)</Frame>
...
<Frame>![Domo MCP server tool permissions list in Claude Desktop](/images/kb/DOMO-MCP-Server-Screenshot-8.png)</Frame>

To test the connection, try a prompt such as: "How many datasets do I have access to?"

<Frame>![Claude Desktop responding to a test query about Domo DataSets](/images/kb/DOMO-MCP-Server-Screenshot-9.png)</Frame>
