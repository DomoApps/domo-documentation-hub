...
4. Enter the application name and select the supported account type. For **Redirect URI**, select **Web** and enter `https://oauth.domo.com/api/data/v1/oauth/providers/sharepointonlinewriteback/exchange`.
