...
excerpt: "Use Domo's OpenAI Administration Connector to import organization, usage, cost, and ChatGPT analytics data from the OpenAI Administration API."
---

## Intro

This article explains how to use Domo's OpenAI Administration Connector to pull organization, usage, cost, and Claude Code analytics data from the OpenAI Administration API into Domo.
